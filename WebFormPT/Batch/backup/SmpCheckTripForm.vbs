...
While not sqlDsc.EOF
	...
	if (strEmpNumber<>"" and strTripDate<>"") then 	
		...
		'objLogFile.Write Now() & " // SQL Statement 取得寫入備註資料:" & strSql & vbCrLf
		...
		'update PALTF set TF010='SPAD00400000536 - 【出差人員：廖廷剛 預計出差日期: 2014/09/16 ~ 2014/09/18】' where TF001='3971' AND TF002='20140916' AND (TF010='' OR TF010 IS NULL) AND  TF905='SPAD004' AND TF004='LI04' AND TF011 <>'V'
