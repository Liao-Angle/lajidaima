...
Set objLogFile = objFileSystem.OpenTextFile("d:\ECP\WebFormPT\Batch\log\SmpCheckTripForm.Log", 8, True) '8 is for appending
...
strSqlDsc = " SELECT TF001, TF002, TF003 FROM SMP..PALTF WHERE TF905='SPAD004' AND (TF010='' OR TF010 IS NULL) and TF004='LI04' AND TF011 <>'V' "
