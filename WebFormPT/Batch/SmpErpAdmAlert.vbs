...
If not sqlEC.eof Then
	strText = "<font lang=""EN-US"" style=""font-size: 9pt; font-family: Tahoma"">[至今日 <"&str_today&"> ERP單據系統關卡未簽核清單 : ]"
	strText = strText & "<table border=0 cellspacing=""1"" cellpadding=""1"" bgcolor=""#C0C0C0"">"
	strText = strText & "<tr style=""font-size: 9pt; font-family: Tahoma""><td>公司別</td><td>單別</td><td>單號</td><td>填表人</td><td>關係人</td><td>TypeCode</td><td>填表日期</td><td>最後關卡簽核日期</td></tr>"
	intCnt = 0
	While not sqlEC.eof
		intCnt = intCnt + 1
	...
	If intCnt > 0 Then
		...
		With cdoMessage
			...
			.Subject = "[New EasyFlow通知]<"&str_today&">ERP單據系統關卡未簽核清單"
			.htmlbody = strText
			.Send
		End With 
