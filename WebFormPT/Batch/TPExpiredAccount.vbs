...
Set objLogFile = objFileSystem.OpenTextFile("d:\ECP\WebFormPT\Batch\log\TPExpiredAccount.Log", 8, True) '8 is for appending
...
strsqlquitemp="select MV001,MV022,MV002,MV004 from CMSMV where MV022 > (getdate()-180) and MV022<=getdate() and MV001 not in ('00066','00067','00068','00096') "
		...
		If RTrim(sqlempquitrs("MV001"))=RTrim(efEmprs("id")) Then
			...
			With cdoMessage 
				Set .Configuration = cdoConfig 
					...
					'.To = "Eva_Fan@simplo.com.tw;cl_chang@simplo.com.tw;Dustin_Cheng@simplo.com.tw"
