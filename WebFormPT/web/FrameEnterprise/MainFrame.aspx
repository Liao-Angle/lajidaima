<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MainFrame.aspx.cs" Inherits="FrameEnterprise_MainFrame" %>
...
<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("MainFrame.aspx.language.ini", "global", "string033", "語系:")%>
   ...
   <%}%>
<span id=LoginInfo class="LoginInfo" style="text-align:right;" align=right><span style="cursor:pointer;" onclick='clickUser()'><%=com.dsc.locale.LocaleString.getMainFrameLocaleString("MainFrame.aspx.language.ini", "global", "string007", "登入使用者:")%></span><%=LoginInfo%></span><span onclick='logout()' style="cursor:pointer;" class=LoginInfo>&nbsp;&nbsp;[<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("MainFrame.aspx.language.ini", "global", "string008", "登出")%>]</span><span onclick='SysInfo()' style="cursor:pointer;" class=LoginInfo>&nbsp;&nbsp;<img src='Images/efHelp.gif' border=0 align=absmiddle title='<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("MainFrame.aspx.language.ini", "global", "string009", "系統資訊")%>' /></span><% if(SMVPAAA017&&com.dsc.kernal.utility.BrowserProcessor.detectBrowser(this.Page).Equals(com.dsc.kernal.utility.BrowserProcessor.BrowserType.IE)){ %><span onclick='downloadActiveX()' class='LoginInfo' style="cursor:pointer;">&nbsp;<img src='Images/download.gif' border=0 align=absmiddle width=16 height=16 title='<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("MainFrame.aspx.language.ini", "global", "string032", "下載元件")%>' /></span><%}%></td></tr></table></span>
<div id='WindowContent' class='WorkSpaceBackground' onmouseout2='Window_Content_MouseEnd();' onmousemove='Window_Content_MouseMove();' onmouseup='Window_Content_MouseEnd();' style="overflow:hidden;border-width:1px;top:83px;left:0px;width:900px;height:450px"></div>
<!--版面列表-->
...
<tr>
    <td width=24px class='MenuHead'>&nbsp;</td>
...
<!--選單：版面排列-->
<!--選單：顯示選單-->
<div id='Menu_SystemMenu' onclick='closeAllMenu()' style="display:none;position:absolute;width:180px;height:24px;top:100px;left:200px;z-index:9998;">
<div style="position:absolute;top:0px;left:0px;width:100%;height:100%">
<iframe frameborder=0 style="top:0px;height:0px;position:absolute;width:100%;height:100%;z-index:-1"></iframe>
<table class='MenuList' border=0 cellpadding=2 cellspacing=0 width=100% height=100%>
<tr>
...
<!--選單：顯示選單-->
<!--選單：版面設定-->
<div id='Menu_Display' onclick='closeAllMenu()' style="display:none;position:absolute;width:180px;height:24px;top:100px;left:200px;z-index:9998;">
<div style="position:absolute;top:0px;left:0px;width:100%;height:100%">
<iframe frameborder=0 style="top:0px;height:0px;position:absolute;width:100%;height:100%;z-index:-1"></iframe>
<table class='MenuList' border=0 cellpadding=2 cellspacing=0 width=100% height=100%>
<tr>
...
<tr>
    <td width=24px class='MenuHead' align=center><input type=checkbox id='Snap_To_Grid' onclick='SnapToGrid_Click();' /></td>
...
<tr>
    <td width=24px class='MenuHead' align=center><input type=checkbox checked id='User_New_Window' onclick='UserNewWindow_Click();' /></td>
...
<tr>
    <td width=24px class='MenuHead' align=center><input type=checkbox id='New_Window_Save' onclick='NewWindowSave_Click();' /></td>
...
<tr>
    <td width=24px class='MenuHead' align=center><input type=checkbox id='New_Window_Dock' onclick='NewWindowDock_Click();' /></td>
...
<div id=MoveFrame style="display:none;position:absolute;width:200px;height:100px;left:150px;top:300px;z-index:99999;border-style:solid;border-width:3px" onmousemove='Window_Content_MouseMove();' onmouseup='Window_Content_MouseEnd();' ondragover='cancelBubble(getEvent());stopEvent(getEvent());'></div>
<div id=AllMaskPanel style="display:none;position:absolute;width:100%;height:100%;left:0px;top:0px;z-index:99999;background-color:#AAAAAA;opacity:0;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0)';" onmousemove='Window_Content_MouseMove();' onmouseup='Window_Content_MouseEnd();' ondrag='cancelBubble(getEvent());stopEvent(getEvent());'></div>
<!--/Portal搬移框-國昌20100318-->
