...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="getMainFrameJS.aspx.cs" Inherits="FrameEnterprise_getMainFrameJS" %>
...
PanelNode.prototype.drawPanel=function(){
  ...
  obj.style.height=(this.height-4)+'px';
  obj.style.width=(this.width-4)+'px';

  obj=document.getElementById('WindowPanel_Content_'+this.panelID);
  //Firefox縮小的大小為20，height不能為負數，因此做判斷
  if (this.height > 32)
    obj.style.height=(this.height-32)+'px';
  else
    obj.style.height='0px';
  obj.style.width=(this.width-4)+'px';

  obj=document.getElementById('WindowPanel_Title_'+this.panelID);
  obj.style.width=this.width-100+'px';
  obj.childNodes[0].style.width=this.width-100+'px';
  ...
  //Firefox縮小的大小為20，height不能為負數，因此做判斷
  if (this.height > 25)
    obj.style.height=(this.height-25)+'px';
  else
    obj.style.height='0px';
  obj.style.width=this.width+'px';
...
PanelNode.prototype.newPanel=function(){
	...
	strs+="<iframe id='WindowPanelMask_IFRAME_"+this.panelID+"' frameborder=0 scrolling=no style='top:2px;height:0px;position:absolute;width:99%;height:99%;z-index:-1;'></iframe>";
	...
	strs+="<tr height=23px class='WindowTitlePanel' style='background-image:url(Images/TBG.gif);'>";
	strs+=" <td width=6px><img src='Images/LT.gif' border=0 /></td>";
	strs+="	<td style='background-image:url(Images/TBG.gif);' width=16px align=center valign=center><"+"img title='<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("getMainFrameJS.aspx.language.ini", "global", "string011", "鎖定位置")%>' id='WindowPanel_Fix_"+this.panelID+"' src='Images/nail_free.gif' border=0 style='cursor:pointer' onclick='Panel_ToggleFix("+this.panelID+")'></td>";
	//國昌20100715-mantis0016825	
	strs+="	<td style='background-image:url(Images/TBG.gif);' width=368px id='WindowPanel_Title_"+this.panelID+"' onmousedown='Panel_Title_MouseDown("+this.panelID+")'"+dblclickevent+"><div style='overflow:hidden;white-space:nowrap;' title='"+this.programID+"'>"+this.title+"</div></td>";
	strs+="	<td style='background-image:url(Images/TBG.gif);' width=16px align=center valign=center><"+"img title='<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("getMainFrameJS.aspx.language.ini", "global", "string008", "目前可儲存視窗狀態")%>' id='WindowPanel_Save_"+this.panelID+"' src='Images/save.gif' border=0 style='cursor:pointer' onclick='Panel_ToggleSave("+this.panelID+")'></td>";
	strs+="	<td style='background-image:url(Images/TBG.gif);' width=16px align=center valign=center><"+"img title='<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("getMainFrameJS.aspx.language.ini", "global", "string006", "目前可停泊邊界")%>' id='WindowPanel_Dock_"+this.panelID+"' src='Images/dock.gif' border=0 style='cursor:pointer' onclick='Panel_ToggleDock("+this.panelID+")'></td>";
	strs+="	<td style='background-image:url(Images/TBG.gif);' width=16px align=center valign=center><"+"img title='<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("getMainFrameJS.aspx.language.ini", "global", "string004", "最小化")%>' id='WindowPanel_State_"+this.panelID+"' src='Images/min.gif' border=0 style='cursor:pointer' onclick='Panel_ToggleSize("+this.panelID+")'></td>";
	strs+="	<td style='background-image:url(Images/TBG.gif);' width=16px align=center valign=center><"+"img title='<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("getMainFrameJS.aspx.language.ini", "global", "string012", "關閉此視窗")%>' id='WindowPanel_Close_"+this.panelID+"' src='Images/cancel.gif' border=0 style='cursor:pointer' onclick='Panel_Close("+this.panelID+")'></td>";
	strs+="	<td width=6px align=center valign=center style='cursor:E-resize;' onmousedown='Panel_WEResize("+this.panelID+")'><img src='Images/RT.gif' border=0 /></td>";
	strs+="</tr>";
	strs+="<tr height=278px id='WindowPanel_Content_"+this.panelID+"'>";
	strs+="<td width=6px style='background-image:url(Images/LB.gif);'></td>";
	...
	strs+="	</td>";
	strs+="<td width=6px style='background-image:url(Images/RB.gif);cursor:E-resize;' onmousedown='Panel_WEResize("+this.panelID+")' ondragstart='cancelBubble(getEvent());stopEvent(getEvent());'></td>";
	strs+="</tr>";
	strs+="<tr height=5px>";
	strs+=" <td width=6px><img src='Images/LD.gif' border=0 /></td>";
	strs+="	<td colspan=6 style='cursor:S-resize;background-image:url(Images/BB.gif);' onmousedown='Panel_NSResize("+this.panelID+")' ondragstart='cancelBubble(getEvent());stopEvent(getEvent());'></td>";
	strs+="	<td width=6px id='WindowPanel_Resize_"+this.panelID+"' class='WindowResizeCell' onmousedown='Panel_Resize("+this.panelID+")' style='cursor:SE-resize;' ondragstart='cancelBubble(getEvent());stopEvent(getEvent());'><img src='Images/RD.gif' border=0 ondragstart='cancelBubble(getEvent());stopEvent(getEvent());'/></td>";
	strs+="</tr>";
	strs+="</table>";
...
function Panel_MinimizeNoneDock()
{
    for(var i=0;i<panelAry.length;i++){
        if((panelAry[i].dockside=='NONE') && (panelAry[i].state=='NORMAL')){
            ...
            //國昌20100716-mantis 0017832原本高度為22應為32
            panelAry[i].height=32;
            panelAry[i].drawPanel();
        }
    }
}
...
{
    openWindowGeneral("<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("getMainFrameJS.aspx.language.ini", "global", "string021", "系統訊息檢視")%>", "FrameEnterprise/SystemMessage.aspx?alertType="+alertType+"&GUID="+alertGUID, 350, 200, "", false, true);
    document.getElementById('SystemAlert').style.display='none';
    window.clearInterval(loopHandle);
    loopHandle=null;
...
function clickUser()
{
    openWindowGeneral("<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("getMainFrameJS.aspx.language.ini", "global", "string022", "線上使用者")%>","FrameEnterprise/showLogonUser.aspx",700, 450, "", false, true);
...
function SysInfo()
{
    openWindowGeneral("<%=com.dsc.locale.LocaleString.getMainFrameLocaleString("getMainFrameJS.aspx.language.ini", "global", "string024", "系統資訊")%>","FrameEnterprise/SysInfo.aspx",600, 400, "", false, true);
}
