<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Maintain.aspx.cs" Inherits="Program_DSCGPFlowService_Maintain_SMWO_Maintain" %>
    ...
    <div>
        ...
        <table >
            <tr>
               ...
               <td>
                   <cc1:SingleDropDownList ID="instanceCompleteType" runat="server" Width=100px />
               </td>
                <td>
                ...
                <td>
                    <cc1:GlassButton ID="RetrieveAllButton" runat="server" Height="20px" OnClick="RetrieveAllButton_Click"
                    Text="取回所有已轉派工作" Width="150px" showWaitingIcon="True" />                
                </td>
            </tr>
        </table>
        </cc1:DSCGroupBox>
