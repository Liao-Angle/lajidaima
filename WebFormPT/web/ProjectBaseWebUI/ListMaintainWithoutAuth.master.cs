...
public partial class ProjectBaseWebUI_ListMaintainWithoutAuth : System.Web.UI.MasterPage
{
    ...
    public void InitData(com.dsc.kernal.databean.DataObject obj)
    {
        ...
        // tony 2013/8/27
        ListTable.NoAdd = NoAdd;
        ListTable.NoDelete = NoDelete;
        /*
        try
        {
            SendButtonClick("(1=2)");
    ...
    protected void ListTable_DeleteData()
    {
        if (DeleteButtonClick != null)
        {
            try
            {
                ...
                string DeleteSuccessMsg = com.dsc.locale.LocaleString.getKernalLocaleString("ProjectBaseWebUI.dll.language.ini", "ListMaintainWithoutAuth", "QueryError1", "刪除成功");
