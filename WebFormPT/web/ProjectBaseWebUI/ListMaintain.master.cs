...
public partial class ProjectBaseWebUI_ListMaintain : System.Web.UI.MasterPage
{
    ...
    protected void ListTable_DeleteData()
    {
        if (DeleteButtonClick != null)
        {
            try
            {
                ...
                string DeleteSuccessMsg = com.dsc.locale.LocaleString.getKernalLocaleString("ProjectBaseWebUI.dll.language.ini", "ListMaintain", "QueryError1", "刪除成功");
