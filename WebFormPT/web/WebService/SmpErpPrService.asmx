    ...
    public string createPrFlow(string headerId, string userId, string subject, string password)
    {
        ...
        if (password.Equals(servicePwd))
        {
            ...
            try
            {
                ...
                sql += "A.QUANTITY,TO_CHAR(A.NEED_BY_DATE, 'YYYY/MM/DD') NEED_BY_DATE,A.LINE_ATTRIBUTE1,A.REQUESTOR_EMPLOYEE_NUM, A.REQUESTOR,";
                ...
                sql += "A.HEADER_ID, B.REQUISITION_LINE_ID, E.EMPLOYEE_NUMBER BUYER_EMPLOYEE_NUMBER, E.EMPLOYEE_NAME BUYER,";
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (int j = 0; j < ds.Tables[0].Rows.Count; j++)
                    {
                        ...
                        //objL.setData("RequesterUserName", Convert.ToString(ds.Tables[0].Rows[j]["REQUESTOR"]));
                        //objL.setData("BuyerUserName", Convert.ToString(ds.Tables[0].Rows[j]["BUYER"]));
                        dos.add(objL);
