...
<body>
    ...
    <div>
        <cc1:DSCTabControl ID="DSCTabControl1" runat="server" Height="280px" Width="600px">
            <TabPages>
                <cc1:DSCTabPage ID="DSCTabPage1" runat="server" Title="預設讀者" Enabled="True" Hidden="False">
                    <TabBody>
                        <div>
                            <cc1:DataList ID="ReadList" runat="server" Height="240px" Width="600px" DialogWidth="600" />
                        </div>
                    </TabBody>
                </cc1:DSCTabPage>
            </TabPages>
