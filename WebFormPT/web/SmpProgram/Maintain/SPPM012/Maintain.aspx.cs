...
public partial class SmpProgram_Maintain_SPPM012_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    private void AllApprove()
    {
        ...
        if (!string.IsNullOrEmpty(sddlAssessmentPlanGUID.ValueText))
        {
            ...
            string sqltxt = "update dbo.SmpPmUserAchievement set SubmitStatus='" + Submit + "' where AssessmentPlanGUID  in (" + SmpPmMaintainUtil.GetfilterNameplanGUID(sddlAssessmentPlanGUID.ValueText) + ") ";
