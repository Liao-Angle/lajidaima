...
public partial class SmpProgram_Maintain_SPPM011_AnalysisNew : BaseWebUI.DataListSaveForm
{
    ...
    protected override void showData(DataObject objects)
    {
        ...
        try
        {
            ...
            cbSubmitStatus.Checked = (objects.getData("SubmitStatus") == "A" || objects.getData("SubmitStatus") == "Y") ? true : false;
    ...
    {
        objects.setData("SubmitStatus", cbSubmitStatus.Checked == true ? "A" : "N");
    ...
    protected override void saveDB(DataObject objects)
    {
        ...
        string sqltxt = "update dbo.SmpPmUserAchievement set SubmitStatus='" + objects.getData("SubmitStatus") + "' where AssessmentPlanGUID  in (" + SmpPmMaintainUtil.GetfilterNameplanGUID(objects.getData("AssessmentName")) + ")  and AssessUserGUID='" + objects.getData("AssessUserGUID") + "'";
