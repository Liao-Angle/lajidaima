<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Maintain.aspx.cs" Inherits="SmpProgram_Maintain_SPPM012_Maintain" %>
	                ...
	                <tr>
                        ...
                        <td>
                            <cc1:GlassButton ID="gbAprove" runat="server" ImageUrl="~/Images/OK.gif" 
                                onclick="gbAprove_Click" Text="一鍵審核" Width="100px" />
                        </td>                                                           
                    </tr>                   
                </table>
            </cc1:DSCGroupBox>            
