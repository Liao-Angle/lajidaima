...
public partial class SmpProgram_Maintain_SPKM001_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((method != null) && (!method.Equals("")))
        {
            if (method.Equals("GetMajorType"))  // MajorType
            {
                ...
                if (string.IsNullOrEmpty(findgroup))
                    sql = "select a.GUID as OID, a.Name as MajorName, a.Enable from SmpMajorType a" +
                          " where dbo.SmpGetMajorTypeAdm(a.GUID) like '%," + UserID + "%'";
                else
                    sql = "select a.GUID as OID, a.Name as MajorName, a.Enable from SmpMajorType a";
            ...
            else if (method.Equals("checkSession"))  // DocType
            {
                string data = "OK123!";
                Response.Clear();
                Response.Write(data);
