...
public partial class SmpProgram_Maintain_SPPM004_Input : BaseWebUI.DataListSaveForm
{
    ...
    protected void showGridViewData(com.dsc.kernal.databean.DataObject objects)
    {
        try
        {
            ...
            //    destRow["GUID"] = data.getData("GUID");
            //    destRow["ItemNo"] = data.getData("ItemNo");
            //    destRow["ItemName"] = data.getData("ItemName");
            //    destRow["Content"] = data.getData("Content");
            //    destRow["FractionExp"] = data.getData("FractionExp");
            //    destRow["MinFraction"] = data.getData("MinFraction");
            //    destRow["MaxFraction"] = data.getData("MaxFraction");
            //    destRow["SelfScore"] = data.getData("SelfScore");
            //    destRow["FirstScore"] = data.getData("FirstScore");
            //    destRow["SecondScore"] = data.getData("SecondScore");
            //    destRow["SelfComments"] = data.getData("SelfComments");
            //    destRow["FirstComments"] = data.getData("FirstComments");
            //    destRow["SecondComments"] = data.getData("SecondComments");
            //    dt.Rows.Add(destRow);
            //}
