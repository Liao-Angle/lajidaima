...
public partial class SmpProgram_Maintain_SPAD005_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((method != null) && (!method.Equals("")))
        {
            if (method.Equals("GetOrganization"))
            {
                ...
                sql = "select OID, id, organizationName from Organization where id in ('SMP','TP') ";
            ...
            else if (method.Equals("GetOrganizationUnit"))
            {
                ...
                sql = "select OID, id, organizationUnitName from SmpOrganizationUnit where organizationOID='" + Utility.filter(orgID) + "' and ";
                if (superID.Equals(""))
                {
