        ...
        if (!string.IsNullOrEmpty(doc_file))
        {
            ...
            if (Ext_Flag == "N")
            {
                ...
                using (PdfStamper pdfStamper = new PdfStamper(reader, new FileStream(filename, FileMode.Create)))
                {
                    for (int i = 1; i <= reader.NumberOfPages; i++)
                    {
                        ...
                        pdfPageContents.SetFontAndSize(bfChinese, 50);
                        ...
                        pdfPageContents.ShowTextAligned(PdfContentByte.ALIGN_CENTER, strDT,
                                         pageSize.Width / 2, pageSize.Height / 2 + 70f, textAngle);
                        pdfPageContents.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "SIMPLO TECHNOLOGY CO., LTD.",
                                         pageSize.Width / 2, pageSize.Height / 2, textAngle);
                        pdfPageContents.ShowTextAligned(PdfContentByte.ALIGN_CENTER, "CONFIDENTIAL DOCUMENT",
                                         pageSize.Width / 2, pageSize.Height / 2 - 70f, textAngle);
            ...
            if (Ext_Flag == "Y")
            {
                ...
                for (int i = 0; i < Document1.Pages.Count; i++)
                {
                    ...
                    c1.Text = strUser + " SIMPLO TECHNOLOGY CO., LTD. CONFIDENTIAL DOCUMENT";
                    c1.Font.Size = 20;
                    c1.Left = 30;
                    c1.Height = 100;
                    c1.Width = 800;
