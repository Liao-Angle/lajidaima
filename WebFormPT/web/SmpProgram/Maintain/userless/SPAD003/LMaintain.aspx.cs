...
public partial class SmpProgram_Maintain_SPAD003_LMaintain : BaseWebUI.GeneralWebPage
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public void start()
    {
        Master.maintainIdentity = "SPAD003";
        Master.ApplicationID = "SMPFORM";
        Master.ModuleID = "SPAD";

        DataObject obj = new DataObject();
        obj.loadFileSchema("WebServerProject.maintain.SPAD003.SmpFunctionsQuery");

        Master.HiddenField = new string[] { "GUID", "EmployeeGUID", "ManagerGUID", "IS_LOCK", "IS_DISPLAY", "DATA_STATUS" };

		Master.DialogHeight = 200;
