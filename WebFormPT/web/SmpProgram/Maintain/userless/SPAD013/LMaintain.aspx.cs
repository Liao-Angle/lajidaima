...
public partial class SmpProgram_Maintain_SPAD013_LMaintain : BaseWebUI.GeneralWebPage
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public void start()
    {
        Master.maintainIdentity = "SPAD013M";
        Master.ApplicationID = "SMPFORM";
        Master.ModuleID = "SPAD";

        DataObject obj = new DataObject();
        obj.loadFileSchema("WebServerProject.maintain.SPAD013.SmpHrStationeryMt");

        Master.HiddenField = new string[] { "GUID", "Attribute2", "Attribute3", "IS_LOCK", "IS_DISPLAY", "DATA_STATUS" };
