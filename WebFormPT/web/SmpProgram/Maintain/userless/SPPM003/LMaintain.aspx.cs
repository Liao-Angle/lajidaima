...
public partial class SmpProgram_Maintain_SPPM003_LMaintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "SPPM003M";
        Master.ApplicationID = "SMPFORM";
        Master.ModuleID = "SPPM";

        DataObject obj = new DataObject();
        obj.loadFileSchema("WebServerProject.maintain.SPPM003.SmpPmAssessmentPlan");

        Master.HiddenField = new string[] { "GUID", "PlanStartDate", "PlanEndDate", "EvaluationGUID", "Remark", "StartDate", "CloseDate", "CancelDate", "IS_LOCK", "IS_DISPLAY", "DATA_STATUS" };
