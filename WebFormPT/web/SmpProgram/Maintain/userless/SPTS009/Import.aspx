<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Import.aspx.cs" Inherits="SmpProgram_Maintain_SPTS009_Import" %>
...
<body>
    ...
    <div>
                ...
                <td width=100% >
                    <cc1:DSCGroupBox ID="DSCGroupBox1" runat="server" Text="匯入說明">
                        ...
                        <cc1:DSCLabel runat="server" ID="ExplainText2" 
                            Text="2. 匯入完畢, 請返回專業人員名冊查詢." Width="292px" />
            ...
            <tr>
                <td width=100% height=100%>
                    <cc1:DSCGroupBox ID="DSCGroupBox2" runat="server" Text="範例與格式下載">
                        <li><a href='#' onclick='window.open("專業人員名冊匯入說明.xls");return false;'><%=TEMPLATEEXP1 %></a></li>
                        <li><a href='#' onclick='window.open("專業人員名冊匯入範例.xls");return false;'><%=TEMPLATEEXP2 %></a></li>
                    </cc1:DSCGroupBox>
                </td>
            </tr>
            <tr>
        ...
        <table>
            <tr><td>
                <cc1:OutDataList ID="DataListProfessional" runat="server" height="220px" width="800px" 
                                            showExcel="True"  
                    NoAdd="True" NoModify="True" IsGeneralUse="True" />
                </td>    
            </tr>
        </table>
    </div>
