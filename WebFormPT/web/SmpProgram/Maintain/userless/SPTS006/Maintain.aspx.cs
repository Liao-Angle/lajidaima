...
public partial class SmpProgram_Maintain_SPTS006_Maintain : BaseWebUI.GeneralWebPage
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public void start()
    {
        Master.maintainIdentity = "SPTS006M";
        Master.ApplicationID = "SMPFORM";
        Master.ModuleID = "SPTS"; //教育訓練模組

        DataObject obj = new DataObject();
        obj.loadFileSchema("WebServerProject.maintain.SPTS006.SmpTSExpertiseRep");
        ...
        sb.Append("   parent.window.openWindowGeneral('人員資格鑑定說明書匯入作業','../Maintain/SPTS008/Import.aspx' ,'','','',true,true);");           
        sb.Append(" }");
        sb.Append("</script>");
