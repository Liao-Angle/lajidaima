<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Import.aspx.cs" Inherits="SmpProgram_Maintain_SPTS008_Import" %>
                ...
                <td width=100% >
                    <cc1:DSCGroupBox ID="DSCGroupBox1" runat="server" Text="匯入說明">
                        ...
                        <cc1:DSCLabel runat="server" ID="ExplainText2" 
                            Text="2. 匯入完畢, 請返回人員資格鑑定說明書查詢." Width="328px" Height="16px" />
