                ...
                <td width=100% >
                    <cc1:DSCGroupBox ID="DSCGroupBox1" runat="server" Text="匯入說明">
                        ...
                        <cc1:DSCLabel runat="server" ID="ExplainText2" 
                            Text="2. 匯入完畢, 請返回自定評核人員查詢." Width="328px" Height="16px" />
            ...
            <tr>
                <td width=100% height=100%>
                    <cc1:DSCGroupBox ID="DSCGroupBox2" runat="server" Text="範例與格式下載">
                        <li><a href='#' onclick='window.open("自定評核人員匯入說明.xls");return false;'><%=TEMPLATEEXP1 %></a></li>
                        <li><a href='#' onclick='window.open("自定評核人員匯入範例.xls");return false;'><%=TEMPLATEEXP2 %></a></li>
                    </cc1:DSCGroupBox>
                </td>
            </tr>
            <tr>
