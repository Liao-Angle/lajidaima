    ...
    <table>
        ...
        <tr><td><cc1:DSCLabel ID="LblMaxFraction" runat="server" Width="90px" Text="最高分數" /></td>
            <td><cc1:SingleField ID="MaxFraction" runat="server" Width="100px" /></td>
                ...
                <tr><td><cc1:DSCLabel ID="lblItemNum" runat="server" Width="90px" Text="項目個數" /></td>
            <td><cc1:SingleField ID="sfItemNum" runat="server" Width="100px" /></td>
        </tr>
                <tr><td><cc1:DSCLabel ID="lblItemWeight" runat="server" Width="90px" Text="權重" 
                        CertificateMode="False" /></td>
            <td><cc1:SingleField ID="sfItemWeight" runat="server" Width="100px" />
                <cc1:DSCLabel ID="DSCLabel3" runat="server" Text="如果權重為20%,則輸入20即可" 
                    Width="250px" />
                    </td>
        </tr>
    </table>
