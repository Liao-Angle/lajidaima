...
<body>
    ...
    <fieldset style="width: 780px">
        ...
        <table style="margin-left:4px; width: 780px;" border=0 cellspacing=0 cellpadding=1 >  
            ...
            <tr><td><cc1:DSCLabel ID="LblActive" runat="server" Width="100px" Text="狀態" TextAlign="2" /></td>
                <td><cc1:SingleDropDownList ID="Active" runat="server" Width="60px" /></td>
            </tr>
        </table>
    </fieldset>
    <table style="margin-left:4px; width: 780px;" border=0 cellspacing=0 cellpadding=1 >  
         <tr>
            <td>
                <cc1:DataList ID="SmpPmEvaluationDetailList" runat="server" Width="780px" 
                    ...
                    onbeforedeletedata="SmpPmEvaluationDetailList_BeforeDeleteData" />
            </td>
        </tr>
    </table> 
    </form>
