...
public partial class SmpProgram_Maintain_SPPM001_LMaintain : BaseWebUI.GeneralWebPage
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public void start()
    {
        Master.maintainIdentity = "SPPM001M";
        Master.ApplicationID = "SMPFORM";
        Master.ModuleID = "SPPM";

        DataObject obj = new DataObject();
        obj.loadFileSchema("WebServerProject.maintain.SPPM001.SmpPmEvaluation");
