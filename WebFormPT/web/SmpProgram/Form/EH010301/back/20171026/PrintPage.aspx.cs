...
public partial class SmpProgram_Form_EH010301_PrintPage : BaseWebUI.GeneralWebPage  //System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
			...
			sql = sql + " , cast(cast(round( a.Hours/8,0) as int)as varchar) hourforDay, cast(cast (a.Hours%8 as int)as varchar) hourforhour FROM EH010301A a,  EH010301B b, SMWYAAA s  ";
