...
public partial class SmpProgram_Form_EH010301_Form : SmpBasicFormPage
{
  ...
  string[,] BB = new string[3, 2]{{"0","白班"},{"1","夜班"},{"2","中班"}};
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        try
        {
			//sw = new System.IO.StreamWriter(@"D:\ECP\WebFormPT\web\LogFolder\EH010301.log", true);
            ...
            if (h1["DutyNo"].ToString() == "5" || h1["DutyNo"].ToString() == "18"||h1["DutyNo"].ToString() == "28"||h1["DutyNo"].ToString() == "34")
            {
                isdsz = "1";
            }
            ...
            if ((getmanagerbool(si.fillerOrgID)) || sum >= 24 ||(str[0].ToString() == "Local  Hired" || str[0] == "台派" || str[0].ToString().Trim()=="責任制(節日報加班)"))
            {
            ...
            string isfz = "0";
            string[] str1 = base.getUserforID(engine, EmpNo.ValueText);
            if ((getpartname(si.fillerOrgID)) && str1[0] != "不限36小時")
            {
                //fz = base.getUserManagerInfoID(engine, mrgmrg)[1];
                isfz = "1";
            }
            ...
            xml += "<mrgisqh DataType=\"java.lang.String\">" + mrgisqh + "</mrgisqh>";//上級主管是否簽核
            xml += "<fz DataType=\"java.lang.String\">" + fz + "</fz>";//副總
            xml += "<isfz DataType=\"java.lang.String\">" + isfz + "</isfz>";//副總是否簽核
