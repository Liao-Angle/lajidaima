<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form.aspx.cs" Inherits="Program_SCQ_Form_SQIT008_Form" %>
...
<body leftmargin="0" topmargin="0">
    ...
    <table style="width: 700px;" border="0" cellspacing="0" cellpadding="1">
        <tr>
            <td align="center" height="30">
                <font style="font-family: 標楷體; font-size: large;"><b>電腦預報廢申請</b></font>
            </td>
        </tr>
    </table>
     <%-- <cc1:DSCTabControl ID="DSCTabAssessment" runat="server" Height="120px" Width="700px"
        PageColor="White">
        <TabPages>--%>
           <%-- <cc1:DSCTabPage runat="server" Title="申請信息" Enabled="True" ImageURL="" Hidden="False"
    ...
    <div>
        <table border="0" cellspacing="0" cellpadding="1" class="BasicFormHeadBorder">
            ...
            <tr>
                <td width="120px" align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="LBEmployeeID" runat="server" Text="申請項目" Width="99px"></cc1:DSCLabel>
                </td>
                <td width="280px"colspan="3" align="left" class="BasicFormHeadDetail">
                    <cc1:SingleField ID="RqType" runat="server" Width="190px" />
                </td>
            </tr>
            <tr>
                <td width="120px" align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel2" runat="server" Text="報廢原因" Width="100px"></cc1:DSCLabel>
                </td>
            ...
            <tr>
                <td width="120px" align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel1" runat="server" Text="報廢說明" Width="100px"></cc1:DSCLabel>
                </td>
                <td colspan="3" width="280px" align="left" class="BasicFormHeadDetail">
            ...
            <tr>
             <td class=BasicFormHeadDetail colspan=4  valign=top>
                 &nbsp;<cc1:OutDataList 
                     ...
                     showTotalRowCount="True" isAskExcelExport="False" IsShowCheckBox="False" 
                     NoAdd="True" NoAllDelete="True" NoDelete="True"></cc1:OutDataList>
            </td>
        </tr> 
        </table>
    </div>
