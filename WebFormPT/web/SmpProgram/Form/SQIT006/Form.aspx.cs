...
public partial class Program_SCQ_Form_SQIT006_Form : SmpBasicFormPage
{
    protected override void init()
    {
        ProcessPageID = "SQIT006";
        AgentSchema = "WebServerProject.form.SQIT006.SQIT006Agent";
    ...
    protected override void initUI(AbstractEngine engine, DataObject objects)
    {
        ...
        if (base.isNew())
        {
            ...
            dos.loadFileSchema();
            objects.setChild("SQIT006B", dos);
            AttachmentList.dataSource = dos;
    ...
    protected override void showData(AbstractEngine engine, DataObject objects)
    {
        ...
        AttachmentList.dataSource = objects.getChild("SQIT006B");
        AttachmentList.updateTable();
    ...
    protected override void saveData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (isAddNew)
        {
            ...
            objects.setChild("SQIT006B", AttachmentList.dataSource);
    ...
    {
        //獲取資訊系統API地址
        string url="http://10.3.11.102/SimploWebAPI/api/IMS_Maintenance/CloseECPStep1";
        bool resultBool = false;

        string sheetNo = currentObject.getData("SheetNo");

        string sql = @"select RqNO from SQIT006A where SheetNo ='" + sheetNo + "'";
