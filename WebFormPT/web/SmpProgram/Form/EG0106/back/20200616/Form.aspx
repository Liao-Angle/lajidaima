                ...
                <td class="BasicFormHeadDetail">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox36" runat="server" Text="待啟用" Width="100px"></cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            ...
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox47" runat="server" Text="一廠ME教育訓練室進" Width="183px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            ...
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox79" runat="server" Text="待啟用" Width="175px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox80" runat="server" Text="待啟用" Width="180px">
                                </cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox105" runat="server" Text="夾層至NPI辦公室" Width="124px"></cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
