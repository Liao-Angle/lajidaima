            ...
            <tr>
                ...
                <td class="BasicFormHeadDetail">
                    <table width="100%">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox57" runat="server" Text="三廠二樓3號門進" Width="167px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox58" runat="server" Text="三廠二樓3號門出" Width="157px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox93" runat="server" Text="IE維修間" Width="128px"></cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox94" runat="server" Text="三廠電梯1" Width="139px"></cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox95" runat="server" Text="待啟用" Width="107px"></cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox96" runat="server" Text="待啟用" Width="108px"></cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="BasicFormHeadDetail">
