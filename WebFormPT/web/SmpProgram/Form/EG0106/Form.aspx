...
<body leftmargin="0" topmargin="0">
    ...
    <div>
        ...
        <table style="margin-left: 0px; width: 970px;" border="0" cellspacing="0" cellpadding="1"
            align="center">
            <tr>
                <td align="center" height="30" class="style6">
        ...
        <table style="margin-left: 4px; width: 877px;" border="0" cellspacing="0" cellpadding="1"
            ...
            <tr>
                <td valign="middle" align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel1" runat="server" Text="人臉門禁權限" Width="120px" Visible="False">
                    </cc1:DSCLabel>
                </td>
                <td class="BasicFormHeadDetail">
                    <cc1:SingleDropDownList ID="djqx" runat="server" Width="200px" Height="16px" Visible="False" />
                </td>
            </tr>
            <tr>
                <td valign="middle" align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="LBPrivilege" runat="server" Text="門禁權限" Width="103px" Height="16px">
                    </cc1:DSCLabel>
                </td>
                <td class="BasicFormHeadDetail">
                    <table width="100%">
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox1" runat="server" Text="一廠二樓MIS主機房進001" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox2" runat="server" Text="一廠二樓MIS主機房出002" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <span style="background-color:#FF95CA; color:Blue">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <span style="background-color:#FF95CA; color:Blue">
                                    <cc1:DSCCheckBox ID="DSCCheckBox5" runat="server" Text="一廠大廳玻璃門進005" Width="200px">
                                    </cc1:DSCCheckBox>
                                </span>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <span style="background-color:#FF95CA; color:Blue">
                                    <cc1:DSCCheckBox ID="DSCCheckBox6" runat="server" Text="一廠大廳玻璃門出006" Width="200px">
                                    </cc1:DSCCheckBox>
                                </span>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox9" runat="server" Text="MIS大廳機房進009" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox10" runat="server" Text="MIS大廳機房出010" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox13" runat="server" Text="一廠一樓HR到大廳進013" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox14" runat="server" Text="一廠一樓HR到大廳出014" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox15" runat="server" Text="待啟用015" Width="220px"></cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox16" runat="server" Text="待啟用016" Width="200px"></cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="BasicFormHeadDetail">
                            ...
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox19" runat="server" Text="待啟用019" Width="200px"></cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox21" runat="server" Text="一廠二樓貴重物品倉出021" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox22" runat="server" Text="一廠二樓貴重物品倉進022" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            ...
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox31" runat="server" Text="一廠二樓關務資料室031" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox32" runat="server" Text="一廠二樓財務資料室032" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox33" runat="server" Text="一廠二樓TE燒佼保進033" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                            ...
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox35" runat="server" Text="一廠二樓量測室035" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox36" runat="server" Text="LAB實驗室036" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox37" runat="server" Text="三廠二樓移印室037" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox41" runat="server" Text="一廠二樓SMT備品房041" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                            ...
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox44" runat="server" Text="待啟用044" Width="200px"></cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="BasicFormHeadDetail">
                            ...
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox47" runat="server" Text="待啟用047" Width="200px"></cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox48" runat="server" Text="一廠碼頭進出048" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox49" runat="server" Text="一廠二樓品保樣品室049" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox50" runat="server" Text="一廠一樓D100 500半成品倉進050" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox51" runat="server" Text="大廳監控室進051" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            ...
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox62" runat="server" Text="三廠2電梯062" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox65" runat="server" Text="貽百樓頂進065" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox66" runat="server" Text="貽百樓頂出066" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                            ...
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox68" runat="server" Text="貽百二樓量測室進068" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox77" runat="server" Text="一廠二樓TE設備間077" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox78" runat="server" Text="一廠二樓TE維修間078" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox79" runat="server" Text="待啟用079" Width="200px"></cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox80" runat="server" Text="待啟用080" Width="200px"></cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox81" runat="server" Text="一廠一樓5號門進081" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox82" runat="server" Text="一廠一樓5號門出082" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox83" runat="server" Text="一廠一樓IE治具室083" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox85" runat="server" Text="待啟用085" Width="200px"></cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox89" runat="server" Text="待啟用089" Width="200px"></cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox93" runat="server" Text="一廠二樓參觀通道進093" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox94" runat="server" Text="一廠二樓參觀通道出094" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox97" runat="server" Text="三廠二樓鐳射間097" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox98" runat="server" Text="三廠二樓鐳射間098" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox99" runat="server" Text="三廠二樓鐳射間099" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox100" runat="server" Text="三廠二樓鐳射間100" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox105" runat="server" Text="三廠夾層至NPI辦公室105" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox106" runat="server" Text="待啟用106" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox107" runat="server" Text="待啟用107" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox108" runat="server" Text="待啟用108" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <span style="background-color:#FF95CA; color:Blue">
                                    <cc1:DSCCheckBox ID="DSCCheckBox121" runat="server" Text="三廠一樓大廳進(人臉)" Width="184px">
                                    </cc1:DSCCheckBox>
                                </span>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox122" runat="server" Text="三廠一樓車間進出(人臉)" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox123" runat="server" Text="三廠一樓車間進辦公室(人臉)" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <span style="background-color:#FF95CA; color:Blue">
                                    <cc1:DSCCheckBox ID="DSCCheckBox124" runat="server" Text="三廠一樓大廳玻璃門進出(人臉)" Width="200px"
                                        Style="color: blue"></cc1:DSCCheckBox>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox125" runat="server" Text="一廠二樓董事長辦公室(人臉)" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
                                <cc1:DSCCheckBox ID="DSCCheckBox126" runat="server" Text="南門三輥閘進出(人臉)" Width="200px">
                                </cc1:DSCCheckBox>
                            </td>
                            <td class="BasicFormHeadDetail">
            ...
            <tr>
                <td align="right" class="BasicFormHeadHead" valign="top" rowspan="2" width="80px">
                    <cc1:DSCLabel ID="LBApplication" runat="server" Text="申請人資料" Width="100px"></cc1:DSCLabel>
                </td>
                <td class="BasicFormHeadDetail">
                        ...
                        <td class=BasicFormHeadDetail colspan=5>
                            <cc1:GlassButton ID="AddData" runat="server" BackColor="White"
                                onclick="AddData_Click" ImageUrl="~\Images\lock.png"
                                 />
                                 <span style=" color:Blue">注：紅底藍字門禁需總經理簽核，不可與其他門禁一起申請</span>
                        </td>
                    </tr>
                </table>
                </panel>
