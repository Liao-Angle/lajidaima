...
public partial class SmpProgram_System_Form_SPERP008_Form : SmpErpPoFormPage
{
    ...
    {
        ProcessPageID = "SPERP008"; //=作業畫面代碼
        AgentSchema = "WebServerProject.form.SPERP008.SmpBlanketPoFormAgent";
    ...
    protected override void initUI(AbstractEngine engine, DataObject objects)
    {
        ...
        sb.Append("     var url = './SPERP008/ViewRfqAward.aspx?PageUniqueID=" + PageUniqueID + "&GUID=';");
