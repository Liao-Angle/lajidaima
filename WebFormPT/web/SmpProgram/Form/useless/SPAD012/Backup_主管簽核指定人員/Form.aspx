...
<body leftmargin=0 topmargin=0>
	...
	<table style="margin-left:4px; width: 660px;" border=0 cellspacing=0 cellpadding=1 class=BasicFormHeadBorder>
		...
		<tr valign="middle" align="center" >
			...
			<td class="BasicFormHeadDetail" align="center">
				<cc1:SingleField ID="ProcessingHours" runat="server" Height="20px" width="150px" />
            </td>
			<td class="BasicFormHeadHead">
				<cc1:DSCLabel ID="DSCLabelProcessingHours" runat="server" Text="(小時)" ></cc1:DSCLabel>
            </td>
			<td class="BasicFormHeadDetail" align="center">
                <cc1:DSCLabel ID="DSCLabel02" runat="server" Text=" " ></cc1:DSCLabel>			
            </td>
		</tr>
        <tr valign="middle" align="center" >
			<td class="BasicFormHeadHead">
