...
public partial class SmpProgram_System_Form_SPAD005_Form : SmpAdFormPage
{
    ...
    protected override void saveData(AbstractEngine engine, DataObject objects)
    {
        try
        {
			...
			writeLog("StartTrvlDate : " + StartTrvlDate.ValueText);
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        try
        {
            ...
            {
                //DateTime sDate = Convert.ToDateTime(ChgStartTrvlDate.ValueText);
                //DateTime eDate = Convert.ToDateTime(ChgEndTrvlDate.ValueText);
            ...
            //if (ChgPrePayTwdAmt.ValueText.Equals("") && ChgPrePayCnyAmt.ValueText.Equals("") && ChgPrePayUsdAmt.ValueText.Equals("") &&
            //    ChgPrePayOtherAmt.ValueText.Equals("") && PrePayTwdAmt.ValueText.Equals("") && PrePayCnyAmt.ValueText.Equals("") &&
            //    PrePayUsdAmt.ValueText.Equals("") && PrePayOtherAmt.ValueText.Equals(""))
            //{
            //    strPreMoney = "N";
            //}
			//預支金額
    ...
    protected void OriForeignForm_SingleOpenWindowButtonClick(string[,] values)
    {
		...
		{
	        sql  = " select AgentGUID, ChgStartTrvlDate, ChgEndTrvlDate, SiteUs, SiteJp, SiteKr, SiteSub, SiteOther, SiteUsDesc, SiteJpDesc, SiteKrDesc, SiteSubDesc, SiteOtherDesc, ";
    ...
    protected void OriForeignForm_BeforeClickButton()
    {
        if (base.isNew())
        {
            OriForeignForm.whereClause = " (BillID is null and ChgID is null and SMWYAAA020 ='Y' and UserId='" + OriginatorGUID.ValueText + "' and (ChgID not in (select c.GUID from SmpForeignTrvlChg c, SMWYAAA w where w.SMWYAAA019=c.GUID and w.SMWYAAA020  in ( 'I','Y' ) )  or ChgID is null )) ";
        }
    }
	...
	private void writeLog(string message)
    {
        ...
        try
        {
            ...
            sw = new System.IO.StreamWriter(serverPath + @"\SPAD005.log", true, System.Text.Encoding.Default);
            sw.WriteLine(line);
        }
        catch (Exception e)
        {
