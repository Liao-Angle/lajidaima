	...
	<table style="table-layout:fixed;WIDTH: 700px; MARGIN-LEFT: 4px" class="BasicFormHeadBorder" border="0" cellSpacing="0" cellPadding="1" id="table2">
		...
		<tr height="20px">
			...
			<td class="SmpPrintPageHeadDetail" colSpan="4">
			  ...
			  <asp:Label id="ChgPrePayJpy" runat="server" visible="false"></asp:Label>
			  <asp:Label id="ChgPrePayJpyAmt" runat="server" visible="false"></asp:Label>
			  <asp:Label id="ChgPrePayEur" runat="server" visible="false"></asp:Label>
			  <asp:Label id="ChgPrePayEurAmt" runat="server" visible="false"></asp:Label>
