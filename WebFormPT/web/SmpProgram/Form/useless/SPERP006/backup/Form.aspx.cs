...
public partial class SmpProgram_System_Form_SPERP006_Form : SmpErpPoFormPage
{
    ...
    {
        ProcessPageID = "SPERP006"; //=作業畫面代碼
        AgentSchema = "WebServerProject.form.SPERP006.SmpRequisitionFormAgent";
    ...
    protected override void initUI(AbstractEngine engine, DataObject objects)
    {
        ...
        string approverId = objects.getData("ApproverId");
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        xml += "<reviewer DataType=\"java.lang.String\">" + approverId + "</reviewer>";
    ...
    protected override string beforeSign(AbstractEngine engine, bool isAfter, string addSignXml)
    {
        ...
        if (addSignXml.Equals(""))
        {
            if (!IsResolved.ValueText.Equals("Y"))
            {
                ...
                setSession("reviewers", reviewers);
    ...
    //protected override void addSignProcedure()
    //{
    //    setSession("IsSignQueue", "N");
    //    base.addSignProcedure();
    //}
    ...
    protected override void afterSign(AbstractEngine engine, DataObject currentObject, string result)
    {
        ...
        if (result.Equals("同意") || signProcess.Equals("Y"))
        {
            ...
            //審核人只有一人
            List<string> reviewers = (List<string>)getSession("reviewers");
            if (reviewers != null)
            {
                if (reviewers.ToArray().Length == 1)
                {
                    needCreateJob = true;
                }
            }
