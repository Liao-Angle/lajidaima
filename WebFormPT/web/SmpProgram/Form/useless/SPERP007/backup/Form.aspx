<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form.aspx.cs" Inherits="SmpProgram_System_Form_SPERP007_Form" %>
...
<body leftmargin=0 topmargin=0>
    ...
    <cc1:GlassButton ID="GbViewAward" runat="server" Height="20px" 
                    Text="View award summary reference" Width="240px" onclick="GbViewAward_Click" />
	<br>
	<br>
</body>
</html>
