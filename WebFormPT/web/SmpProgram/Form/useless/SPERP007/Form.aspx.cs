...
public partial class SmpProgram_System_Form_SPERP007_Form : SmpErpPoFormPage
{
    ...
    {
        ProcessPageID = "SPERP007"; //=作業畫面代碼
        AgentSchema = "WebServerProject.form.SPERP007.SmpStandardPoFormAgent";
    ...
    {        
        ...
        sb.Append("     var url = './SPERP007/ViewRfqAward.aspx?PageUniqueID=" + PageUniqueID + "&GUID=';");
        ...
        if (!objects.getData("HtmlContentExt").Equals(""))
        {
        ...
        if (isAddNew)
        {
            ...
            objects.setData("Subject", "主旨 - 測試(原物料PO) - " + i);
            objects.setData("TypeCode", "PO");
            OriginatorId.ValueText = "4019";
            ReviewerId.ValueText = 
			"<list>"+
	...
	private void writeLog(string message)
    {
        ...
        try
        {
            ...
            sw = new System.IO.StreamWriter(serverPath + @"\SPERP007.log", true, System.Text.Encoding.Default);
            sw.WriteLine(line);
        }
        catch (Exception e)
        {
