...
<body leftmargin=0 topmargin=0>
    ...
    <table style="margin-left:4px; width: 660px;" border=0 cellspacing=0 cellpadding=1 class=BasicFormHeadBorder>
		<tr><td align="right" class="BasicFormHeadHead">
                <cc1:DSCLabel ID="LblCompanyCode" runat="server" Text="公司別" Width="85px"  TextAlign="2" />
            </td>
            <td class=BasicFormHeadDetail colspan=5>
                <cc1:SingleField ID="CompanyCode" runat="server" Width="560px" />
            </td>
        </tr>
        <tr><td align="right" class="BasicFormHeadHead">
        ...
        <tr>
	        ...
	        <td class=BasicFormHeadDetail>
                <cc1:SingleOpenWindowField ID="RdMemberGUID" 
                    runat="server" Width="120px" showReadOnlyField="True" guidField="OID" 
                    keyField="id" serialNum="003" tableName="Users" idIndex="2" valueIndex="3" 
                    onbeforeclickbutton="RdMemberGUID_BeforeClickButton" IgnoreCase="True"/> 
            </td>
        </tr>
        <tr>
            <td align="right" class="BasicFormHeadHead">
	        ...
	        <td class=BasicFormHeadDetail>
                <cc1:SingleOpenWindowField ID="MeMemberGUID" 
                    runat="server" Width="120px" showReadOnlyField="True" guidField="OID" 
                    keyField="id" serialNum="003" tableName="Users" idIndex="2" valueIndex="3" 
                    onbeforeclickbutton="MeMemberGUID_BeforeClickButton" IgnoreCase="True"/> 
	        ...
	        <td class=BasicFormHeadDetail>
                <cc1:SingleOpenWindowField ID="PmMemberGUID" 
                    runat="server" Width="120px" showReadOnlyField="True" guidField="OID" 
                    keyField="id" serialNum="003" tableName="Users" idIndex="2" valueIndex="3" 
                    onbeforeclickbutton="PmMemberGUID_BeforeClickButton" IgnoreCase="True"/>
            </td>
            <td align="right" class="BasicFormHeadHead">
	        ...
	        <td class=BasicFormHeadDetail>
                <cc1:SingleOpenWindowField ID="SaleMemberGUID" 
                    runat="server" Width="120px" showReadOnlyField="True" guidField="OID" 
                    keyField="id" serialNum="003" tableName="Users" idIndex="2" valueIndex="3" 
                    onbeforeclickbutton="SaleMemberGUID_BeforeClickButton" IgnoreCase="True"/>
            </td>
        </tr>
        <tr>
            <td align="right" class="BasicFormHeadHead">
	        ...
	        <td class=BasicFormHeadDetail>
                <cc1:SingleOpenWindowField ID="McMemberGUID" 
                    runat="server" Width="120px" showReadOnlyField="True" guidField="OID" 
                    keyField="id" serialNum="003" tableName="Users" idIndex="2" valueIndex="3" 
                    onbeforeclickbutton="McMemberGUID_BeforeClickButton" IgnoreCase="True"/>
            </td>
            <td align="right" class="BasicFormHeadHead">
	        ...
	        <td class=BasicFormHeadDetail>
                <cc1:SingleOpenWindowField ID="QaMemberGUID" 
                    runat="server" Width="120px" showReadOnlyField="True" guidField="OID" 
                    keyField="id" serialNum="003" tableName="Users" idIndex="2" valueIndex="3" 
                    onbeforeclickbutton="QaMemberGUID_BeforeClickButton" IgnoreCase="True"/>
            </td>
            <td align="right" class="BasicFormHeadHead">
	        ...
	        <td class=BasicFormHeadDetail>
                <cc1:SingleOpenWindowField ID="SaleManagerGUID" 
                    runat="server" Width="120px" showReadOnlyField="True" guidField="OID" 
                    keyField="id" serialNum="003" tableName="Users" idIndex="2" valueIndex="3" 
                    onbeforeclickbutton="SaleManagerGUID_BeforeClickButton" IgnoreCase="True"/>
            </td>
        </tr>
		<tr>
            <td align="right" class="BasicFormHeadHead">
                <cc1:DSCLabel ID="lbSqeMemberGUID" runat="server" Text="SQE" Width="85px"  TextAlign="2" />
            </td>
	        <td class=BasicFormHeadDetail>
                <cc1:SingleOpenWindowField ID="SqeMemberGUID" 
                    runat="server" Width="120px" showReadOnlyField="True" guidField="OID" 
                    keyField="id" serialNum="003" tableName="Users" idIndex="2" valueIndex="3" 
                    onbeforeclickbutton="SqeMemberGUID_BeforeClickButton" IgnoreCase="True"/>
            </td>
            <td align="right" class="BasicFormHeadHead">
                <cc1:DSCLabel ID="lbPurMemberGUID" runat="server" Text="採購" Width="85px"  TextAlign="2" />
            </td>
	        <td class=BasicFormHeadDetail>
                <cc1:SingleOpenWindowField ID="PurMemberGUID" 
                    runat="server" Width="120px" showReadOnlyField="True" guidField="OID" 
                    keyField="id" serialNum="003" tableName="Users" idIndex="2" valueIndex="3" 
                    onbeforeclickbutton="PurMemberGUID_BeforeClickButton" IgnoreCase="True"/>
            </td>
            <td align="right" class="BasicFormHeadHead">
                <cc1:DSCLabel ID="lbGUID11" runat="server" Text=" " Width="85px"  TextAlign="2" />
            </td>
	        <td class=BasicFormHeadDetail>
                 <cc1:DSCLabel ID="lbGUID112" runat="server" Text=" " Width="85px"  TextAlign="2" />
            </td>
        </tr>
    </table>
    <br>
