...
<div>
	...
	<cc1:SingleField ID="FeeCharge" runat="server" />
	...
	<table style="margin-left:4px; width: 660px;" border=0 cellspacing=0 cellpadding=1 class=BasicFormHeadBorder>
		<tr>
			<td colSpan="5" class="BasicFormHeadHead" Width="100%"><b>				
				<cc1:GlassButton ID="PrintButton1" runat="server" Height="20px" Width="100%" 
                    Text="列印國外出差單" onbeforeclicks="PrintButton1_OnClick" Enabled="True" /></b>
			</td>
		</tr>	
		<tr>
	    ...
	    <tr height="30">
			<td class="BasicFormHeadHead" colSpan="5">
				...
				<font size="2" color="#ff0000" align="right">
				<cc1:DSCLabel ID="LblOtherDesc" runat="server" Text="" width="560px" /></cc1:DSCLabel>
				</font>
			</td>
		</tr>
		<tr height="30">
		...
		<tr height="30">
			...
			<td class="BasicFormHeadDetail" colSpan="4">
				...
				<cc1:SingleField ID="SiteOtherDesc" runat="server" Height="20px" Width="70px" /><br>
				<font size="2" color="#fa0a00">**出差至子公司請攜帶新普/嘉普識別證**</font>
				<br>				
				<font size="2" color="#fa0a00">**請出差人員出差前，務必去出差專區閱讀出差須知**
				<b><asp:HyperLink ID="TripHyperLink" runat="server" Text="[點擊連結查看]" Target="_blank" /></font><b>
		    </td>
	    </tr>						
	    <!--<tr height="30px">				
		...
		<tr height="30">
		    <td class="BasicFormHeadDetail" colSpan="5">
                ...
                <font size="2" color="#ff0000"><b>** 如未填列預支申請而已完成簽核者,財務部即不再受理預支申請 **</b></font></br>
				<!--<font size="2" color="#550aff"><b>*** 嘉普人員至105/12/31止國外出差費請款(發票、收據等)請使用中普統一編號:54542191 ***</b></font>-->
            </td>
	    </tr>		
    </table>
	</div>
