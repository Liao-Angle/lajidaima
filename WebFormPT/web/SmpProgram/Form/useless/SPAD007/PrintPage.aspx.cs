...
public partial class SmpProgram_Form_SPAD007_PrintPage : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
			...
			sql = sql + " , FeeCharge, TrvlDesc, PrePayTwd, PrePayTwdAmt, PrePayCny, PrePayCnyAmt, PrePayUsd, PrePayUsdAmt, PrePayJpy, PrePayJpyAmt, PrePayEur, PrePayEurAmt, PrePayOther, PrePayOtherAmt, PrePayComment ";
			...
			sql = sql + " , ChgTrvlDesc, ChgStartTrvlDate, ChgEndTrvlDate, ChgPrePayTwd, ChgPrePayTwdAmt, ChgPrePayCny, ChgPrePayCnyAmt, ChgPrePayUsd, ChgPrePayUsdAmt, ChgPrePayJpy, ChgPrePayJpyAmt, ChgPrePayEur, ChgPrePayEurAmt, ChgPrePayOther, ChgPrePayOtherAmt  ";
