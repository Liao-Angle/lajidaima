...
public partial class SmpProgram_System_Form_SPAD009_Form : SmpAdFormPage
{
    ...
    protected override void saveData(AbstractEngine engine, DataObject objects)
    {
        ...
        try
        {
            ...
            if (isAddNew)
            {
				...
				//sw.WriteLine("EndTime :  " + EndTime.ValueText);
				objects.setData("IsHrForm", "Y");
                //if (IsHrForm.Checked)  {objects.setData("IsHrForm", "Y");} else {objects.setData("IsHrForm", "N");}
				...
				//sw.WriteLine("Notes :  " + Notes.ValueText);
    ...
    protected override bool checkFieldData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (actName.Equals(""))
        {
			...
			//MessageBox("sDate=>"+sDate + "  - eDate=>" + eDate + "\n -- ==> 差異天數 " + days);
    ...
    {     
        ...
        try
        {
			...
			//sw.WriteLine("checkFlag=" + checkFlag);
			...
			//sw.WriteLine("before isBillAmount=" + isBillAmount);
            ...
            string checkFlag2 = "N";
            //string deptId = currentObject.getData("DeptGUID").ToString;
            ...
            try
            {
                sql = "select CheckValue2 from SmpFlowInspect where FormId='SPAD009' and CheckField1='DeptId' and CheckValue1='" + deptId + "' and Status='Y' ";
    ...
    private Boolean updateHR()
    {
        ...
        ////出差時間超過1730, 寫入資料1730至刷卡紀錄更新 HR 資料庫!        
        //decimal tmpEndTime = decimal.Parse(endTime.Substring(0, 2));
        ////MessageBox("tmpEndTime : " + tmpEndTime );
        //if (tmpEndTime >= 17)
        //{
        //    endTime = "1730"; //出差訖刷卡時間
        //    strMC003e = endTime;
        //}
        ...
        try
        {
            ...
            //string hrconStr = sp.getParam(strCompanyCode+"WorkFlowERPDB");//由變數取得 HRDB connection string, 如同下列字串            
    ...
    {
		writeLog("updateHR StartTime:" +  currentObject.getData("StartTime"));
        //prepare update sql string
        //string strSQL = prepareSQL(STARTTIME.ValueText);
        //MessageBox(strSQL);
    ...
    {		
		writeLog("prepareSQL currentObject CompanyCode:" +  currentObject.getData("CompanyCode"));
    ...
    private string tripDateCheck(string tripDate, string userGuid)
    {
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                //sw.WriteLine("strErrMsg : " + strErrMsg);
            }
