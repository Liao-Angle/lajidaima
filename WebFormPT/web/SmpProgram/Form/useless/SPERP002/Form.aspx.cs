...
public partial class SmpProgram_System_Form_SPERP002_Form : SmpErpFormPage
{
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        {        	
			string actName = (string)getSession("ACTName");
				writeLog("setFlowVariables actName: " + actName );
            SubmitInfo si = (SubmitInfo)getSession("SubmitInfo");
            //填表人
			...
			writeLog("setFlowVariables purMemberGUID: " + purMemberGUID );
			
			values = base.getUserInfo(engine, purMemberGUID);
			string buyerId = values[0];
			
			writeLog("setFlowVariables buyerId: " + buyerId );
            ...
            decimal isBillAmount = decimal.Parse(currentObject.getData("FunctionAmount"));
			...
			string flag1 = "";
			sql = "select CheckValue2 from SmpFlowInspect where FormId='" + ProcessPageID + "' and CheckField1='DeptId' and CheckValue1='" + si.ownerOrgID + "' and Status='Y'";
			writeLog("setFlowVariables SQL: " + sql );
			...
			sql = "select CheckValue2 from SmpFlowInspect where FormId='" + ProcessPageID + "' and CheckField1='UserId' and CheckValue1='" + PurMemberGUID.ValueText + "'   and Status='Y'";
			writeLog("setFlowVariables SQL: " + sql );
            ...
            xml += "<originator DataType=\"java.lang.String\">" + PurMemberGUID.ValueText + "</originator>";
    ...
    private string updateSourceStatus(string status)
    {
        ...
        //sw.WriteLine("updateSourceStatus=>" + status);

        string result = "";
        //string poNumber = PoNumber.ValueText;
        string poNumber = PoNumber.ValueText;

        //sw.WriteLine("poNumber=>" + poNumber);
        //sw.Close();
        if (!poNumber.Equals(""))
        {            
