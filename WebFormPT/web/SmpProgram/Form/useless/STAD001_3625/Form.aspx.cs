...
public partial class SmpProgram_Form_STAD001_3625_Form : SmpAdFormPage
{
    ...
    {       
		ProcessPageID = "STAD001_3625"; //作業畫面代碼
        AgentSchema = "WebServerProject.form.STAD001_3625.SmpAdBusinessCardAgent";
    ...
    protected override void saveData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (isAddNew)
        {
            ...
            objects.setData("IS_DISPLAY", "Y"); //必須要作的
    ...
    protected override bool checkFieldData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (!strErrMsg.Equals(""))
        {
            pushErrorMessage(strErrMsg); //顯示錯誤訊息
            result = false;
        }
