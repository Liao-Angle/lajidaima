<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form.aspx.cs" Inherits="SmpProgram_System_Form_SPERP011_Form" %>
...
<body leftmargin=0 topmargin=0>
   ...
   <tr>
	...
	<tr>
	  ...
	  <td align="right" class="BasicFormHeadHead">
        <cc1:DSCLabel ID="LblReviewer1" runat="server" Text="審核人一" Width="85px" IsNecessary="False" TextAlign="2" />
      </td>
	  <td class=BasicFormHeadDetail>
	  ...
	  <td align="right" class="BasicFormHeadHead">
        <cc1:DSCLabel ID="LblReviewer2" runat="server" Text="審核人二" Width="85px" IsNecessary="False" TextAlign="2" />
      </td>
	  <td class=BasicFormHeadDetail>
