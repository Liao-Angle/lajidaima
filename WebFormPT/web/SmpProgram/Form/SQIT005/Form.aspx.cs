...
public partial class Program_SCQ_Form_SQIT005_Form : SmpBasicFormPage
{
    protected override void init()
    {
        ProcessPageID = "SQIT005";
        AgentSchema = "WebServerProject.form.SQIT005.SQIT005Agent";
    ...
    protected override void showData(AbstractEngine engine, DataObject objects)
    {
        ...
        ExtensionDate1.ValueText = objects.getData("ExtensionDate1");
        ExtensionDate2.ValueText = objects.getData("ExtensionDate2");
        wbs.ValueText = objects.getData("wbs");
        ExtensionReason.ValueText = objects.getData("ExtensionReason");
    ...
    protected override void saveData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (isAddNew)
        {
            ...
            objects.setData("ExtensionDate1", ExtensionDate1.ValueText);
            objects.setData("ExtensionDate2", ExtensionDate2.ValueText);
            objects.setData("wbs", wbs.ValueText);
            objects.setData("ExtensionReason", ExtensionReason.ValueText);
    ...
    {
         //獲取資訊系統API地址
        string url = "http://10.3.11.102/SimploWebAPI/api/IRS_Requirements/CloseECPDelay";
        bool resultBool = false;

        string sheetNo = currentObject.getData("SheetNo");

        string sql = @"select RqNO,wbs from SQIT005A where SheetNo ='" + sheetNo + "'";
        ...
        Json.AppendFormat("\"wbs\":\"{0}\",", wbs);
        Json.AppendFormat("\"ecpnumber\":\"{0}\"", sheetNo);
        Json.AppendFormat("{0}", "}");
        try
        {
    ...
    private void writeLog(string message)
    {
        ...
        try
        {
            ...
            sw = new System.IO.StreamWriter(serverPath + @"\SQIT005.log", true, System.Text.Encoding.Default);
            sw.WriteLine(line);
        }
        catch (Exception e)
        {
