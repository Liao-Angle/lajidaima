<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form.aspx.cs" Inherits="Program_SCQ_Form_SQIT005_Form" %>
    ...
    <table style="width: 670px;" border="0" cellspacing="0" cellpadding="1">
        <tr>
            <td align="center" height="30">
                <font style="font-family: 標楷體; font-size: large;"><b>資訊需求展延申請單</b></font>
            </td>
        </tr>
    </table>
    <div>
        ...
        <table border="0" cellspacing="0" cellpadding="1" class="BasicFormHeadBorder">
            ...
            <tr>
                <td width="120px" align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel17" runat="server" Text="展延前日期" Width="99px"></cc1:DSCLabel>
                </td>
                <td width="280px" align="left" class="BasicFormHeadDetail">
                    <cc1:SingleField ID="ExtensionDate1" runat="server" Width="100px" />
                </td>
                <td width="120px" align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel18" runat="server" Text="展延後日期" Width="100px"></cc1:DSCLabel>
                </td>
                <td width="280px" align="left" class="BasicFormHeadDetail">
                    <cc1:SingleField ID="ExtensionDate2" runat="server" Width="100px" />
                </td>
                <td width="120px" align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel20" runat="server" Text="展延版本" Width="100px"></cc1:DSCLabel>
                </td>
                <td width="280px" align="left" class="BasicFormHeadDetail">
                    <cc1:SingleField ID="wbs" runat="server" Width="100px" />
                </td>
            </tr>
            <tr>
                <td width="120px" align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel19" runat="server" Text="展延原因" Width="100px"></cc1:DSCLabel>
                </td>
                <td colspan="5" width="280px" align="left" class="BasicFormHeadDetail">
                    <cc1:SingleField ID="ExtensionReason" runat="server" Width="555px" Height="48px" 
                        MultiLine="True" />
                </td>
            </tr>
        </table>
