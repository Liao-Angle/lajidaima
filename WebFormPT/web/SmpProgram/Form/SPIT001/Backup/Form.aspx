<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form.aspx.cs" Inherits="SmpProgram_System_Form_SPIT001_Form" %>
	...
	<table style="margin-left:4px; width: 660px;" border=0 cellspacing=0 cellpadding=1 class=BasicFormHeadBorder>
        ...
        <tr valign="middle">
			<td class="BasicFormHeadHead" align="center">
				<cc1:DSCLabel ID="DSCLabel1" runat="server" Text="公司" IsNecessary="true"></cc1:DSCLabel>
            </td>
			<td class="BasicFormHeadHead" align="center">
				<cc1:DSCLabel ID="DSCLabel3" runat="server" Text="工號" IsNecessary="true"></cc1:DSCLabel>
            </td>
			<td class="BasicFormHeadHead" align="center">
				<cc1:DSCLabel ID="DSCLabel8" runat="server" Text="申請人(中)"  IsNecessary="true"></cc1:DSCLabel>
            </td>
		    <td class="BasicFormHeadHead" align="center">
				<cc1:DSCLabel ID="DSCLabel9" runat="server" Text="申請人(英)" IsNecessary="true"></cc1:DSCLabel>
            </td>
		</tr>
		...
		<tr valign="middle">
			<td class="BasicFormHeadHead" align="center">
				<cc1:DSCLabel ID="DSCLabel2" runat="server" Text="部門" IsNecessary="true"></cc1:DSCLabel>
            </td>
			<td class="BasicFormHeadHead" align="center">
				<cc1:DSCLabel ID="DSCLabel10" runat="server" Text="職稱" IsNecessary="true"></cc1:DSCLabel>
            </td>
			<td class="BasicFormHeadHead" align="center">
				<cc1:DSCLabel ID="DSCLabel11" runat="server" Text="審核人" ></cc1:DSCLabel>
			</td>
			<td class="BasicFormHeadHead" align="center">
				<cc1:DSCLabel ID="DSCLabel121" runat="server" Text="申請人分機" IsNecessary="true"></cc1:DSCLabel>
            </td>				        
		</tr>
		<tr valign="middle" align="center">
			<td class=BasicFormHeadDetail>
        ...
        <tr valign="middle" align="center" >
			<td class="BasicFormHeadHead" align="center">
				<cc1:DSCLabel ID="DSCLabel22" runat="server" Text="會簽人員1" ></cc1:DSCLabel>
            </td>
			<td class="BasicFormHeadHead" align="center">
				<cc1:DSCLabel ID="DSCLabel23" runat="server" Text="會簽人員2" ></cc1:DSCLabel>
            </td>
			<td class="BasicFormHeadHead">
				<cc1:DSCLabel ID="DSCLabel25" runat="server" Text="MIS承辦人" ></cc1:DSCLabel>
			</td>
			<td class="BasicFormHeadHead">
