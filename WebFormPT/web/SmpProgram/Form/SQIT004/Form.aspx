    ...
    <div>
        <table border="0" cellspacing="0" cellpadding="1" class="BasicFormHeadBorder">
            ...
            <tr>
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                    <cc1:SingleField ID="RqType" runat="server" Width="225px" />
                </td><td width="120px" align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel17" runat="server" Text="新增設備" Width="99px"></cc1:DSCLabel>
                </td>
                <td width="280px" align="left" class="BasicFormHeadDetail">
                    <cc1:SingleField ID="xzsb" runat="server" Width="188px" ReadOnly="True" />
                </td>
            </tr>
            <tr>
                <td width="120px" align="right" class="BasicFormHeadHead">
      ...
      <fieldset style="width: 670px; height: 256px">
                <legend><span class="my_txt">簽核意見</span></legend>
