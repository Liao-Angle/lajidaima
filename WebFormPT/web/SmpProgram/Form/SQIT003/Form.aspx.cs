...
public partial class Program_SCQ_Form_SQIT003_Form : SmpBasicFormPage
{
    protected override void init()
    {
        ProcessPageID = "SQIT003";
        AgentSchema = "WebServerProject.form.SQIT003.SQIT003Agent";
    ...
    {
        //獲取資訊系統API地址
        string url="http://10.3.11.102/SimploWebAPI/api/IRS_Requirements/CloseECPStep1";
        bool resultBool = false;

        string sheetNo = currentObject.getData("SheetNo");

        string sql = @"select RqNO from SQIT003A where SheetNo ='" + sheetNo + "'";
    ...
    private void writeLog(string message)
    {
        ...
        try
        {
            ...
            sw = new System.IO.StreamWriter(serverPath + @"\SQIT003.log", true, System.Text.Encoding.Default);
            sw.WriteLine(line);
        }
        catch (Exception e)
        {
