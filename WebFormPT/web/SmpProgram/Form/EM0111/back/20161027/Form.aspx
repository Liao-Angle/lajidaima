...
<body leftmargin=0 topmargin=0>
    ...
    <div>
        ...
        <table border="0" cellspacing="0" cellpadding="1" class="BasicFormHeadBorder">
                ...
                <cc1:SingleField ID="zb" runat="server" Width="100px" style="text-align: center" />塊
                </td>
                <td width=120px align="right" class="BasicFormHeadHead">
                <cc1:DSCLabel ID="DSCLabel17" runat="server" Text="CPU" Width="102px" />
                </td>
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="cpu" runat="server" Width="100px" style="text-align: center" />塊
                </td>
                <td width=120px align="right" class="BasicFormHeadHead">
                <cc1:DSCLabel ID="DSCLabel1" runat="server" Text="CPU風扇" Width="102px" />
                </td>
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="cupfs" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                </tr>
                </table>
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="disk" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                <td width=120px align="right" class="BasicFormHeadHead">
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="powerx" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                <td width=120px align="right" class="BasicFormHeadHead">
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="powerd" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                </tr>
                </table>
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="mouse" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                <td width=120px align="right" class="BasicFormHeadHead">
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="keyboardx" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                <td width=120px align="right" class="BasicFormHeadHead">
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="keyboardd" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                </tr>
                </table>
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="bzwk" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                <td width=120px align="right" class="BasicFormHeadHead">
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="qzwk" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                <td width=120px align="right" class="BasicFormHeadHead">
                <cc1:DSCLabel ID="DSCLabel12" runat="server" Text="電話機" Width="102px"></cc1:DSCLabel></td>
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="telphone" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                </tr>
                </table>
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="memory" runat="server" Width="100px" 
                        style="text-align: center" />個
                </td>
                <td width=120px align="right" class="BasicFormHeadHead">
                ...
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="xk" runat="server" Width="100px" style="text-align: center" />個
                </td>
                <td width=120px align="right" class="BasicFormHeadHead">
                <cc1:DSCLabel ID="DSCLabel11" runat="server" Text="網線" Width="102px" />
                </td>
                <td width="280px" align="left" class="BasicFormHeadDetail">
                <cc1:SingleField ID="wx" runat="server" Width="100px" style="text-align: center" />米
                </td>
                </tr>
                </table>
            ...
            class="BasicFormHeadBorder" style="width: 700px; height: 41px;">
                <tr>
                <td colspan=4 align="left" class="BasicFormHeadHead"><strong>領用人簽字: </strong> </td>
                </tr>
                </table>
                ...
                <td class="BasicFormHeadHead" colspan="3" style="height: 17px">
                 <cc1:DSCLabel ID="DSCLabel18" runat="server" Text="請選擇簽核主管" Width="150px" Height="20px"></cc1:DSCLabel>
                </td>
                <td class="BasicFormHeadHead" colspan="3" style="height: 17px">
