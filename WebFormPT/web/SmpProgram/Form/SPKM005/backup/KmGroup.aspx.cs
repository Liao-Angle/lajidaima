...
public partial class SmpProgram_Form_SPKM005_KmGroup : BaseWebUI.WebFormBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (source.Equals("KM"))
        {
            ...
            string uiStatus = "8";
            string GroupGUID = Request.QueryString["KmGroup"];
            string objectGUID = "";
            string isMaintain = "Y";
            ...
            string sql = "  select BelongGroupGUID from SmpDocBelongGroup where d.DocGUID='" + docGUID + "'  ";
			...
			Session["SmpKmGroup"] = objectGUID;
			string url = "http://192.168.2.226/ecp/SmpProgram/Maintain/SPKMGROUP/Maintain.aspx";
