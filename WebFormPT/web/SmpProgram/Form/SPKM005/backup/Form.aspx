                        ...
                        <TabBody>
                            <table width="100%">
                                ...
                                <tr><td align=right>
                                    ...
                                    <td colspan="3">
                                        <cc1:SingleOpenWindowField ID="SubTypeGUID" runat="server" 
                                            ...
                                            onbeforeclickbutton="SubTypeGUID_BeforeClickButton" /></td>
                                </tr>
                                <tr><td align=right>
                                        ...
                                        <td colspan=3>
                                            ...
                                            FixValueTextWidth="330px" 
                                                onbeforeclickbutton="DocTypeGUID_BeforeClickButton" /></td>
                                        <td><cc1:DSCLabel ID="LblExternal" runat="server" Text="外來文件" Width="70px" TextAlign="2" />
                                        </td>
                                        <td>
                                ...
                                <tr><td align=right>
                                    ...
                                    <td><cc1:SingleField ID="Site" runat="server" Width="90px" ReadOnly="True" /></td>
                                    <td align=right>
                                ...
                                <tr><td align="right">
                                    ...
                                    <td align="right"><cc1:DSCLabel ID="LblAuthorOrgUnitGUID" runat="server" Text="製定部門" Width="70px" 
                                            IsNecessary="False" TextAlign="2" /></td>
                                    <td><cc1:SingleOpenWindowField ID="AuthorOrgUnitGUID" runat="server" 
                                            Width="110px" guidField="OID" keyField="id" 
