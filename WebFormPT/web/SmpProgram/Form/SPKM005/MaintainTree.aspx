<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaintainTree.aspx.cs" Inherits="SmpProgram_Form_SPKM005_MaintainTree" %>
...
<head runat="server">
    ...
    <script language="javascript">
        ...
        function getMajorType() {
            ...
            xmlhttp.open('POST', 'MaintainTree.aspx', false);
        ...
        function showMajorType(OID) {
            //document.getElementById('DetailView').src = 'ViewDetail.aspx?OID=' + OID + '&KIND=Major';
        }

        function showSubType(OID) {
            //document.getElementById('DetailView').src = 'ViewDetail.aspx?OID=' + OID + '&KIND=Sub';
        }

        function showDocType(OID) {
            document.getElementById('DetailView').src = 'ViewDetail.aspx?OID=' + OID + '&KIND=Doc';
        }
        ...
        function openDocWindowGeneral(title, url, bWidth, bHeight, frameType, isMax, newWindow) {
            window.parent.openWindowGeneral(title, url, bWidth, bHeight, frameType, isMax, newWindow);
        }
    </script>
</head>
<body topmargin="0" leftmargin="0" onload='getMajorType()' scroll="no" >
