                            ...
                            <table style="width: 100%">
                                <tr><td align=right>
                                    ...
                                    <cc1:SingleOpenWindowField ID="DocGUID" runat="server" 
                                            ...
                                            FixValueTextWidth="130px" Enabled="False" ReadOnly="True" Display="True" 
                                ...
                                <tr><td align="right">
                                        <cc1:DSCLabel ID="LblName" runat="server" Text="文件名稱" Width="70px" 
                                            IsNecessary="True" TextAlign="2" /></td>
                                    <td colspan=6><cc1:SingleField ID="Name" runat="server" Width="556px" /></td>
                                </tr>
                                <tr><td align=right>
                                        <cc1:DSCLabel ID="LblMajorTypeGUID" runat="server" Text="主分類" Width="70px" 
                                            IsNecessary="True" TextAlign="2" /></td>
                                    <td class="style7"><cc1:SingleOpenWindowField ID="MajorTypeGUID" runat="server" 
                                            ...
                                            onbeforeclickbutton="MajorTypeGUID_BeforeClickButton" /></td>
                                ...
                                <tr><td align=right>
										...
										<td align=right colspan="2">
                                            <cc1:DSCLabel ID="LblExternal" runat="server" Text="包含外來文件" Width="88px" 
                                                TextAlign="2" />
                                        </td>                                      
                                    <td>
                                ...
                                <tr><td align=right>
                                        <cc1:DSCLabel ID="LblSite" runat="server" Text="廠區" Width="70px" 
                                                IsNecessary="False" TextAlign="2" ReadOnly="True" /></td>
                                    <td class="style7"><cc1:SingleField ID="Site" runat="server" Width="90px" ReadOnly="True" /></td>
                                    <td align=right class="style5">
                                ...
                                <tr><td align="right">
                                    ...
                                    <td><cc1:SingleOpenWindowField ID="CreatorGUID" runat="server" Width="90px" 
                                            ...
                                            FixValueTextWidth="80px" HiddenButton="True" HiddenText="True" 
                                            showReadOnlyField="True" /></td>
                                    <td align="right" colspan="2"><cc1:DSCLabel ID="LblAuthorOrgUnitGUID" runat="server" Text="製定部門" Width="70px" 
                                            IsNecessary="False" TextAlign="2" /></td>
                                    <td>
                                        <cc1:SingleOpenWindowField ID="AuthorOrgUnitGUID" runat="server" 
                                            FixReadOnlyValueTextWidth="100px" FixValueTextWidth="107px" guidField="OID" 
                                            HiddenButton="True" HiddenText="True" keyField="id" serialNum="001" 
                                            showReadOnlyField="True" tableName="OrgUnit" Width="98px" />
                                    </td>
                                </tr>                               
                                <tr><td align="right">
                                ...
                                <tr><td><cc1:DSCLabel ID="LblExpiryDate" runat="server" Text="到期日" Width="70px" 
                                            TextAlign="2" /></td>
                                    <td class="style7"><cc1:SingleDateTimeField ID="ExpiryDate" runat="server" Width="110px" /></td>
                                    <td class="style5"><cc1:DSCLabel ID="LblEffectiveDate" runat="server" Text="生效日" Width="70px" 
                                            TextAlign="2" /></td>
                            ...
                            <table width="100%">
                                <tr>
                                    <td colspan="4" style="text-align: left">
                                        <asp:Label ID="Label3" runat="server" ForeColor="Red" 
                                            style="font-size: 9pt; text-align: left;" Text="*附件若為外來文件，請先選取附件->指定「是否為外來文件」下拉值為「是」-> 點選修改銨鈕" 
                                ...
                                <tr><td><cc1:OpenFileUpload ID="FileUploadAtta" runat="server" onaddoutline="Atta_AddOutline" />
                                    ...
                                    <td colspan="3" style="text-align: left">
                                        <asp:HyperLink ID="HyperLink1" runat="server" Text="文件範本下載" Font-Size="Smaller" 
                                            NavigateUrl="http://smpportal.simplo.com.tw/MIS/SOP/Forms/AllItems.aspx?RootFolder=%2FMIS%2FSOP%2FeKM&FolderCTID=0x0120001CF56CF5C7AE084B87A84DAA7E7407AD&View={29483A50-7FB9-43E4-9353-339A24594014}" 
                                            Target="_blank" />  
                                    </td>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <cc1:DSCLabel ID="LblAttaExternal" runat="server" Text="是否為外來文件" TextAlign="2" 
                                            Width="120px" />
                                    </td>
                                    <td>
                                ...
                                <tr><td align="right" Width="70px">
                                    ...
                                    <td>
                                        <cc1:SingleOpenWindowField ID="ReferenceGUID" runat="server" 
                                            ...
                                            FixValueTextWidth="90px" 
                                            onbeforeclickbutton="ReferenceGUID_BeforeClickButton" /></td>
                                </tr>
                                <tr><td colspan=4>
                                ...
                                <tr><td align="right">
                                    ...
                                    <td width="555px">
                                        <cc1:SingleOpenWindowField ID="ReaderBelongGroupGUID" runat="server" 
                                            Width="420px" showReadOnlyField="True" guidField="OID" keyField="id" 
                                            serialNum="001" tableName="SPKM001" FixReadOnlyValueTextWidth="240px" 
                                            FixValueTextWidth="120px" /></td>
                                </tr>                               
                                <tr><td colspan="4">
