...
public partial class SmpProgram_Form_SPKM001_Form : SmpKmFormPage
{
    ...
    protected override void saveData(AbstractEngine engine, DataObject objects)
    {
        ...
        try
        {
            ...
            if (actName.Equals("文管中心"))
            {
                ...
                string originatorName = CreatorGUID.ReadOnlyValueText;
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        if (!notifier.Contains(CreatorGUID.ValueText))
        {
            notifier += CreatorGUID.ValueText;
        }
    ...
    {        
        try
        {
            ...
            sql = "insert into SmpIndexCard (GUID, Status, MajorTypeGUID, SubTypeGUID, DocTypeGUID, DocPropertyGUID, ConfidentialLevel, DocGUID, Name, Abstract, KeyWords, EffectiveDate, ExpiryDate, "
                + "IS_LOCK, IS_DISPLAY, DATA_STATUS, D_INSERTUSER, D_INSERTTIME, D_MODIFYUSER, D_MODIFYTIME,External) SELECT '"
                + indexCardGUID + "' ,'Create','" + MajorTypeGUID.GuidValueText + "','" + SubTypeGUID.GuidValueText + "','"
            ...
            //obj.setData("Status", Status.ValueText);
    ...
    {        
        ...
        {          
            ...
            string sql = null;
            string expiryDate = ExpiryDate.ValueText;
            string docNo = getCustomSheetNo(engine, "SMPKMDOCSeqNo");
