...
public partial class Program_System_Form_STDDOCTEST_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "STDDOCTEST";
        Master.ApplicationID = "SYSTEM";
        Master.ModuleID = "SAMPLE";
        DataObject obj = new DataObject();
        obj.loadFileSchema("WebServerProject.form.STDDOCTEST.STDDOCTEST");
    ...
    public void Master_SendButtonClick(string whereClause)
    {
        ...
        agent.loadSchema("WebServerProject.form.STDDOCTEST.STDDOCTESTAgent");
        agent.engine = engine;
