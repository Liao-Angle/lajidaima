...
public partial class Program_System_Form_STDDOC_Q1100459_STDDOC_Q1100459 : BasicFormPage
{
    ...
    {
        ProcessPageID = "STDDOC_Q1100459";
        AgentSchema = "WebServerProject.form.STDDOC_Q1100459.STDDOC_Q1100459Agent";
    ...
    protected override bool checkFieldData(AbstractEngine engine, DataObject objects)
    {
        ...
        //System.IO.StreamWriter sw = new System.IO.StreamWriter(@"",true,System.Text.Encoding.UTF8);
        //sw.WriteLine("XXXXX");
        //sw.Close();
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        //param["TEST"] = "<TEST><TEST01 dataType=\"java.lang.String\">4020</TEST01>";

        param["TEST"] = "<TEST>";
        param["TEST"] += " <TEST01 dataType=\"java.lang.String\">4020</TEST01>";
        param["TEST"] += " <TEST02 dataType=\"java.lang.Integer\">1234</TEST02>";
        param["TEST"] += " <TEST03 dataType=\"java.lang.String\">4019</TEST03>";
        param["TEST"] += " <TEST04 dataType=\"java.lang.String\">3787</TEST04>";
        param["TEST"] += "</TEST>";
        return "TEST";
    }
