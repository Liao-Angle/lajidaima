<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Maintain.aspx.cs" Inherits="Program_System_Maintain_SMVQ_Maintain" %>
...
<body>
    ...
    <div>
        ...
        <tr>
            ...
            <td>
                <cc1:DSCRadioButton ID="TYUser" GroupName="TY" Text="使用者" runat="server" Checked="true" />
                <cc1:DSCRadioButton ID="TYIP" GroupName="TY" Text="IP位置" runat="server" />
            </td>
        </tr>
        <tr>
