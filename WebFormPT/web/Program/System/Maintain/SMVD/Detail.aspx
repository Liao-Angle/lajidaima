...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <cc1:DSCGroupBox ID="DSCGroupBox1" runat="server" Height="176px" Text="已通知清單" Width="583px">
            <cc1:DataList ID="ReadList" runat="server" Height="160px" NoAdd="True" NoDelete="True"
                NoModify="True" ReadOnly="True" Width="571px" />
        </cc1:DSCGroupBox>
