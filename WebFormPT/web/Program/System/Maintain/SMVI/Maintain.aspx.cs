...
public partial class Program_System_Maintain_SMVI_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "SMVI";
        Master.ApplicationID = "SYSTEM";
        Master.ModuleID = "SMVAA";
        SMVIAAA obj = new SMVIAAA();
        Master.HiddenField = new string[] { "SMVIAAA001"};
