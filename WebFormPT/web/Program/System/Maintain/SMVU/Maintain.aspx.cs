...
public partial class Program_System_Maintain_SMVU_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "SMVU";
        Master.ApplicationID = "SYSTEM";
        Master.ModuleID = "SMVAA";
        SMVUAAA obj = new SMVUAAA();
        Master.HiddenField = new string[] { "SMVUAAA001"};
