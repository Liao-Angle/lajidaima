...
public partial class Program_DSCGPFlowService_Maintain_SMWH_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "SMWH";
        Master.ApplicationID = "SYSTEM";
        Master.ModuleID = "SMWAA";
        SMWHAAA obj = new SMWHAAA();
        Master.HiddenField = new string[] { "SMWHAAA001"};
