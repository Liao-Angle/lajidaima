...
public partial class Program_DSCGPFlowService_Maintain_SMWS_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "SMWS";
        Master.ApplicationID = "SYSTEM";
        Master.ModuleID = "SMWAA";
        SMWSAAA obj = new SMWSAAA();
        Master.HiddenField = new string[] { "SMWSAAA001","SMWSAAA004","SMWSAAA005"};
