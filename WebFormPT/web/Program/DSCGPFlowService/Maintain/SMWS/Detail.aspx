<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="Program_DSCGPFlowService_Maintain_SMWS_Detail" %>
...
<body>
    ...
    <div>
        ...
        &nbsp;&nbsp;<cc1:SingleField ID="SMWSAAA002" runat="server" Width="178px" ReadOnly="False" />
        <br />
        <cc1:DSCLabel ID="DSCLabel2" runat="server" Text="資料夾名稱" Width="120px" />
        &nbsp;&nbsp;<cc1:SingleField ID="SMWSAAA003" runat="server" Width="413px" ReadOnly="False" />
        &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        <cc1:DSCTabControl ID="DSCTabControl1" runat="server" Height="300px" Width="524px">
            <TabPages>
                ...
                <TabBody>
                    &nbsp;<cc1:DSCRadioButton ID="SMWSAAA0040" runat="server" Checked="True" GroupName="SMWSAAA004"
                        Text="所有流程, 除以下之外" />
                    <cc1:DSCRadioButton ID="SMWSAAA0041" runat="server" GroupName="SMWSAAA004" Text="僅以下流程" />
                    <cc1:DSCLabel ID="DSCLabel21" runat="server" Text="選擇流程" Width="78px" />
                    <cc1:SingleDropDownList ID="SMWSAAB003" runat="server" Width="148px" />
                    <br />
                ...
                <TabBody>
                    &nbsp;<cc1:DSCRadioButton ID="SMWSAAA0050" runat="server" Checked="True" GroupName="SMWSAAA005"
                        Text="所有角色, 除以下之外" />
                    <cc1:DSCRadioButton ID="SMWSAAA0051" runat="server" GroupName="SMWSAAA005" Text="僅以下角色" />
                    <cc1:DSCLabel ID="DSCLabel1" runat="server" Text="選擇角色" Width="78px" />
                    <cc1:SingleDropDownList ID="SMWSAAC003" runat="server" Width="148px" />
                    <br />
