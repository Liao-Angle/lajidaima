<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SmpInfo.aspx.cs" Inherits="Program_DSCGPFlowService_Public_Info" %>
...
<body>
    ...
    <tr>
        <td valign=top class="style1"><cc1:DSCLabel ID="DSCLabel1" runat="server" 
                Text="請選擇要通知的類型：" Width="147px" /></td>
        <td valign=top colspan=2>
            <cc1:SingleDropDownList ID="NoticeType" runat="server" Width="300px" />
        </td>
    </tr>
    <tr>
        <td valign=top class="style1"><cc1:DSCLabel ID="DSCLabel2" runat="server" 
                Text="請選擇要通知的人員：" Width="147px" />
            <br />
        ...
        <td class="style1"><cc1:DSCLabel ID="DSCLabel3" runat="server" Text="意見：" 
                Width="147px" />
            </td>
        <td>
            <cc1:SingleField ID="ForwardComment" runat="server" Width="298px" Height="60px" 
                MultiLine="True" />
        </td>
        <td></td>
    <tr>
