<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowOpinion.aspx.cs" Inherits="Program_DSCGPFlowService_Public_ShowOpinion" %>
...
<body>
    ...
    <tr>
        <td colspan=2 align=center>
            ...
            <cc1:GlassButton ID="SendButton" runat="server" Text="送出簽核" ConfirmText="確定送出?" OnClick="SendButton_Click" Width="100px" ImageUrl="~/Images/OK.gif" />
        </td>
    </tr>
    </table>
    </div>
