...
public partial class Program_DSCAuditService_Maintain_SMXF_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "SMXF";
        Master.ApplicationID = "SYSTEM";
        Master.ModuleID = "SMXAA";
        SMXFAAA obj = new SMXFAAA();
        Master.HiddenField = new string[] { "SMXDAAB001","SMXDAAB002","SMXDAAB007","SMXDAAA003"};
