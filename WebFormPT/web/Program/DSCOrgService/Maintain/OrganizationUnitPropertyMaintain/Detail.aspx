<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="Program_DSCOrgService_Maintain_OrganizationUnitPropertyMaintain_Detail" %>
...
<body>
    ...
    <div>
        <table style="width: 662px;font-size:9pt">
            ...
            <tr>
                <td style="width: 123px"><cc1:DSCLabel ID="DSCLabel3" runat="server" Text="屬姓名稱" Width="80px" />
                    </td>
                <td colspan="3"><cc1:SingleField ID="organizationUnitPropertyNameF" runat="server" Width="100%" ReadOnly="true" />
                </td>
                </td>
            </tr>
            <tr>
                <td style="width: 123px"><cc1:DSCLabel ID="DSCLabel4" runat="server" Text="公司識別碼" Width="100px" />
                    </td>
                <td style="width: 180px"><cc1:SingleField ID="organizationOIDF" runat="server" Width="100%" ReadOnly="true" />
                </td>
                <td style="width: 134px"><cc1:DSCLabel ID="DSCLabel5" runat="server" Text="公司名稱" Width="80px" />
                    </td>
                <td style="width: 145px"><cc1:SingleField ID="organizationNameF" runat="server" Width="100%" ReadOnly="true" />
                </td>
            </tr>
            <tr>
                <td style="width: 123px"><cc1:DSCLabel ID="DSCLabel6" runat="server" Text="說明" Width="80px" />
                    </td>
