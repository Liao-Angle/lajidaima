...
public partial class Program_DSCOrgService_Maintain_OrganizationUnitPropertyMaintain_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "OrganizationUnitPropertyMaintain";
        OrganizationUnitProperty obj = new OrganizationUnitProperty();
    ...
    public void Master_SendButtonClick(string whereClause)
    {
        ...
        OrganizationUnitPropertyAgent agent = new OrganizationUnitPropertyAgent();
        agent.engine = engine;
