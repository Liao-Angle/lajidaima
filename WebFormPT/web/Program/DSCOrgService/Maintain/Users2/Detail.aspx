...
<body>
    ...
    <div>
        <table style="width: 662px;font-size:9pt">
            <tr>
                <td><cc1:DSCLabel ID="DSCLabel3" runat="server" Text="使用者代號" Width="100px" />
                    </td>
                <td><cc1:SingleField ID="idF" runat="server" Width="150px"  />
                    <cc1:GlassButton ID="CheckButton" runat="server" OnClick="CheckButton_Click" CssClass="GlassButton" ImageUrl="~/DSCWebControlRunTime/DSCWebControlImages/FIND.gif" />
                </td>
                <td><cc1:DSCLabel ID="DSCLabel4" runat="server" Text="使用者姓名" Width="100px" />
                    </td>
            ...
            <tr>
                ...
                <td colspan=3><cc1:SingleField ID="mailAddressF" runat="server" Width="350px" ValueText="@simplo.com.cn"  />
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="3">
                    <cc1:DSCLabel ID="msgF" runat="server" ForeColor="Red" />
                </td>
            </tr>
        </table>
