<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="Program_DSCOrgService_Maintain_FunctionLevelMaintain_Detail" %>
...
<body>
    ...
    <div>
        <table style="width: 662px;font-size:9pt">
            ...
            <tr>
                <td style="width: 123px"><cc1:DSCLabel ID="DSCLabel3" runat="server" Text="職務層級的級數" Width="200px" />
                    </td>
                <td style="width: 180px"><cc1:SingleField ID="levelValueF" runat="server" Width="100%" ReadOnly="true" />
                </td>
                <td style="width: 134px"><cc1:DSCLabel ID="DSCLabel4" runat="server" Text="職務層級的名稱" Width="200px" />
                    </td>
                <td style="width: 145px"><cc1:SingleField ID="functionLevelNameF" runat="server" Width="100%" ReadOnly="true" />
                </td>
            </tr>
            <tr>
