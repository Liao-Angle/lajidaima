...
public partial class Program_DSCOrgService_Maintain_FunctionLevelMaintain_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "FunctionLevelMaintain";

        FunctionLevel obj = new FunctionLevel();
    ...
    public void Master_SendButtonClick(string whereClause)
    {
        ...
        FunctionLevelAgent agent = new FunctionLevelAgent();
        agent.engine = engine;
