<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Maintain.aspx.cs" Inherits="Program_DSCOrgService_Maintain_OrganizationMaintain_Maintain" %>
...
function getOrganization()
{
    ...
    for(var i=0;i<data.length;i++){
        ...
        strs+="<div nowrap=true id='O_"+line[0]+"'><img src='c.gif' border=0 id='I_"+line[0]+"' orgid='"+line[0]+"' oid='"+line[0]+"' state='N' level=0 onclick='toggleOrganization(\"\");'><span onclick='showOrganization(\""+line[0]+"\");' style=\"cursor:pointer\">"+line[1]+" "+line[2]+"</span></div>";
    ...
    if(obj.getAttribute('state')=='N'){
        ...
        if(tooltree.length>0){
            ...
            for(var i=0;i<data.length;i++){
                ...
                strs+="<img src='c.gif' border=0 id='I_"+line[0]+"' orgid='"+obj.getAttribute('orgid')+"' oid='"+line[0]+"' state='N' level="+curLevel+" onclick='toggleOrganization(\""+line[0]+"\");'><span onclick='showOrganizationUnit(\""+line[0]+"\");' style=\"cursor:pointer\">"+line[1]+" "+line[2]+"</span></div>";
                strs+="<div nowrap=true id='D_"+line[0]+"' style=\"display:none\"></div>";
            }
