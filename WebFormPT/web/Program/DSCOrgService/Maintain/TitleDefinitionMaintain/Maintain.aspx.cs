...
public partial class Program_DSCOrgService_Maintain_TitleDefinitionMaintain_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "TitleDefinitionMaintain";
        TitleDefinition obj = new TitleDefinition();
    ...
    public void Master_SendButtonClick(string whereClause)
    {
        ...
        TitleDefinitionAgent agent = new TitleDefinitionAgent();
        agent.engine = engine;
