<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="Program_DSCOrgService_Maintain_TitleDefinitionMaintain_Detail" %>
    ...
    <div>
        <table style="width: 662px;font-size:9pt">
            ...
            <tr>
                ...
                <td style="width: 180px"><cc1:SingleField ID="titleDefinitionNameF" runat="server" Width="100%" ReadOnly="true" />
                </td>
