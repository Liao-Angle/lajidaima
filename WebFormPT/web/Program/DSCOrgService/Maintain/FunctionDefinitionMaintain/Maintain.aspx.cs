...
public partial class Program_DSCOrgService_Maintain_FunctionDefinitionMaintain_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "FunctionDefinitionMaintain";
    ...
    public void Master_SendButtonClick(string whereClause)
    {
        ...
        FunctionDefinitionAgent agent = new FunctionDefinitionAgent();
        agent.engine = engine;
