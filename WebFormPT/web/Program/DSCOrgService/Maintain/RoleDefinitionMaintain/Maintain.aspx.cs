...
public partial class Program_DSCOrgService_Maintain_RoleDefinitionMaintain_Maintain : BaseWebUI.GeneralWebPage
{
    ...
    public void start()
    {
        Master.maintainIdentity = "RoleDefinitionMaintain";
    ...
    public void Master_SendButtonClick(string whereClause)
    {
        ...
        RoleDefinitionAgent agent = new RoleDefinitionAgent();
        agent.engine = engine;
