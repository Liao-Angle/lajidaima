<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detail.aspx.cs" Inherits="Program_DSCOrgService_Maintain_RoleDefinitionMaintain_Detail" %>
...
<body>
    ...
    <div>
        <table style="width: 662px;font-size:9pt">
            ...
            <tr>
                <td style="width: 123px"><cc1:DSCLabel ID="DSCLabel3" runat="server" Text="角色名稱" Width="80px" />
                    </td>
                <td style="width: 180px"><cc1:SingleField ID="roleDefinitionNameF" runat="server" Width="100%" ReadOnly="true" />
                </td>
                <td style="width: 134px"><cc1:DSCLabel ID="DSCLabel4" runat="server" Text="角色簡稱" Width="80px" />
                    </td>
