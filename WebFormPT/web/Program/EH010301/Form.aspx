...
<body leftmargin=0 topmargin=0>
    ...
    <table style="margin-left:4px; width: 660px;" border=0 cellspacing=0 cellpadding=1>  
        ...
        <tr valign=middle > 
		    <td align=center height="40"><font style="font-family: 標楷體; font-size: large;"><b>請假單</b></font></td>
	    </tr>
	</table>
        ...
        <tr>
            <td align=right class=BasicFormHeadHead>
                <cc1:GlassButton ID="LBYearStatus" runat="server" Width="100%" OnClick="LBYear_Click" Text="年度狀況"/>
            </td>
