...
public partial class Program_SCQ_Form_EH0112_PrintPage : BaseWebUI.GeneralWebPage  //System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string strSheetNo = (string)Session["EH0113_SheetNo"];
            if (Session["EH0113_SheetNo"] != null)
            {
                strSheetNo = (string)Session["EH0113_SheetNo"];

            }
            if (strUserId.Substring(0, 1) == "Y")
            {
            ...
            //顯示使用者資訊
            sql = @"SELECT   a.EmpNo,a.EmpName, a.PartNo, a.TryDateB, a.DtName,Dt,TryDateE,ComeDate,Reason,a.SheetNo, 
                    s.SMWYAAA006 as Subject, s.SMWYAAA008, s.SMWYAAA009, s.SMWYAAA010 
                    FROM EH0113A a, SMWYAAA s where s.SMWYAAA019=a.GUID and a.SheetNo='" + strSheetNo + "'";
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                Reason.ValueText = ds.Tables[0].Rows[0]["Reason"].ToString();
    ...
    public DataSet fh_sj(string SheetNo)
    {
        ...
        sql = sql + " from WebFormPT.dbo.EH0113A as sr ";
