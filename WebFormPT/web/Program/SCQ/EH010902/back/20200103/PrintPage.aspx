<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintPage.aspx.cs" Inherits="Program_SCQ_Form_EH010902_PrintPage" %>
            ...
            <tr>
               ...
               <td class="BasicFormHeadDetail">
                    <cc1:SingleField ID="zhize" runat="server" MultiLine="True" 
                        Width="606px" Height="82px" style="margin-left: 35px" ReadOnly="True" />
               </td> 
            </tr>
            </table>
            <table style="margin-left:4px; width: 660px;" border="0" cellspacing="0" cellpadding="1">
