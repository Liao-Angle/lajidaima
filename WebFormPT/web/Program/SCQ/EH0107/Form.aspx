        ...
        <table width="680px" border="1" cellspacing="0" cellpadding="1" class="BasicFormHeadBorder">
            <tr>
                <td colspan="6" align="left" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel1" runat="server" Text="填單人" Width="60px" />
                </td>
            </tr>
            <tr>
                <td class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="Label2" runat="server" Text="申請人" Width="60px" />
                </td>
                ...
                <td class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="Label1" runat="server" Text="部門" Width="50px"></cc1:DSCLabel>
                </td>
                <td class="BasicFormHeadDetail">
                    <cc1:SingleField ID="partNouser" runat="server" Width="97px" />
                </td>
                <td class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="Label3" runat="server" Text="申請日期" Width="100px"></cc1:DSCLabel>
                </td>
                <td class="BasicFormHeadDetail">
                    <cc1:SingleField ID="Cdate" runat="server" Width="81px" />
                </td>
            </tr>
            <tr id="User1S" runat="server">
                <td colspan="6" align="left" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel2" runat="server" Text="資料" Width="70px"></cc1:DSCLabel>
                </td>
            </tr>
            <tr id="User2S" runat="server">
                <td  colspan="6" class="BasicFormHeadHead">
                    <cc1:DSCTabControl ID="DSCTabControl1" runat="server" Height="70px" 
                        Width="680px" style="text-align: left">
                        <TabPages>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" class="BasicFormHeadDetail">
                                                    員工&nbsp;<cc1:SingleOpenWindowField ID="EmpNo" runat="server" Width="189px" idIndex="0"
            ...
            <tr id="User6S" runat="server">
                <td align="right" class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel3" runat="server" Text="日 期" Width="70px"></cc1:DSCLabel>
                </td>
                <td class="BasicFormHeadHead">
            ...
            <tr id="User3S" runat="server">
                <td class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel5" runat="server" Text="科目類型" Width="70px"></cc1:DSCLabel>
                </td>
                <td class="BasicFormHeadHead">
            ...
            <tr id="User4S" runat="server">
                <td class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel7" runat="server" Text="申請原因" Width="70px" 
                        Height="16px"></cc1:DSCLabel>
                </td>
                <td colspan="5">
                    <cc1:SingleField ID="Note" runat="server" Height="92px" Width="570px" 
                        MultiLine="True" />
                </td>
            </tr>
            <tr id="User5S" runat="server">
                <td class="BasicFormHeadHead">
                    <cc1:DSCLabel ID="DSCLabel8" runat="server" Text="備注說明" Width="70px"></cc1:DSCLabel>
                </td>
                <td colspan="5">
                    <cc1:SingleField ID="Remark" runat="server" Height="92px" Width="570px" 
                        MultiLine="True" />
                </td>
            </tr>
            <tr>
                <td colspan="1" align="left" class="BasicFormHeadHead">
                        <cc1:DSCLabel ID="DSCLabel9" runat="server" Text="注意" Width="70px" 
                            ForeColor="Blue"></cc1:DSCLabel>
                </td>
                <td colspan="5" class="BasicFormHeadDetail" >
                    <cc1:DSCLabel ID="DSCLabel10" runat="server" 
                        Text="高溫補貼<=465;崗位津貼,特殊/重點<=140 多能工/儲備<=200;崗位補貼<=200" Width="580px" 
            ...
            <tr>
                <td colspan="6">
                    <cc1:OutDataList ID="LeaveDateList" runat="server" Height="250px" ViewStateMode="Disabled"
                        Width="650px" NoModify="True" IsExcelWithMultiType="True" showTotalRowCount="True"
                    ...
                    <span style="margin-top: 0px; padding-top: 0px">
                        <cc1:FileUpload ID="FileUpload1" runat="server" NoDelete="True" OnAddOutline="FileUpload1_AddOutline"
                            Width="20px" BorderStyle="None" ViewStateMode="Disabled" Height="234px" />
                    </span>
                </td>
            </tr>
