...
public partial class Program_SCQ_Form_EM0109_Form : SmpBasicFormPage
{
    ...
    protected override void showData(AbstractEngine engine, DataObject objects)
    {
        ...
        bzcb.ValueText = objects.getData("bzcb");
    ...
    protected override void saveData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (isAddNew)
        {
            ...
            objects.setData("bzcb", bzcb.ValueText);
    ...
    protected override bool checkFieldData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (DtName.ValueText == "司機" && Convert.ToInt32(ApplyAmount.ValueText)>120 && string.IsNullOrEmpty(bzcb.ValueText))
        {
            pushErrorMessage("司機補助超過120，請填寫額度超標說明！");
            result = false;
        }
        if (DtName.ValueText == "副主任" && Convert.ToInt32(ApplyAmount.ValueText) > 75 && string.IsNullOrEmpty(bzcb.ValueText))
        {
            pushErrorMessage("副主任補助超過75，請填寫額度超標說明！");
            result = false;
        }
        if (DtName.ValueText == "主任" && Convert.ToInt32(ApplyAmount.ValueText) > 75 && string.IsNullOrEmpty(bzcb.ValueText))
        {
            pushErrorMessage("主任補助超過75，請填寫額度超標說明！");
            result = false;
        }
        if ((DtName.ValueText == "副理" || DtName.ValueText == "專案經理") && Convert.ToInt32(ApplyAmount.ValueText) > 120 && string.IsNullOrEmpty(bzcb.ValueText))
        {
            pushErrorMessage("副理補助超過120，請填寫額度超標說明！");
            result = false;
        }
        if (DtName.ValueText == "經理" && Convert.ToInt32(ApplyAmount.ValueText) > 160 && string.IsNullOrEmpty(bzcb.ValueText))
        {
            pushErrorMessage("經理補助超過160，請填寫額度超標說明！");
            result = false;
        }
        if ((DtName.ValueText == "協理" || DtName.ValueText == "處長") && Convert.ToInt32(ApplyAmount.ValueText) > 180 && string.IsNullOrEmpty(bzcb.ValueText))
        {
            pushErrorMessage("司機補助超過180，請填寫額度超標說明！");
            result = false;
        }
