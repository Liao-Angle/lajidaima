<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form.aspx.cs" Inherits="Program_SCQ_Form_EH0110_Form" %>
        ...
        <tr>
            <td class="BasicFormHeadHead" style="width: 37px; height: 26px">
             ...
             <td class="BasicFormHeadDetail">
                    <cc1:SingleOpenWindowField ID="EmpNo" runat="server" Width="221px" showReadOnlyField="True"
                ...
                <td class="BasicFormHeadDetail">
                    <cc1:SingleField ID="ComeDate" runat="server" Width="93px" Height="16px" />
                </td>
                <td class="BasicFormHeadHead" style="width: 37px; height: 26px">
                    <cc1:DSCLabel ID="DSCLabel3" runat="server" Text="年資" Width="72px" />
                </td>
                <td class="BasicFormHeadDetail">
                    <cc1:SingleField ID="NZ" runat="server" Width="130px" Height="16px" 
                        ReadOnly="True" />
                </td>
        </tr>
     </table>
      <table style="margin-left:4px; width: 700px;" class="BasicFormHeadBorder" border="0" cellspacing="0" cellpadding="1">
        ...
        <table style="margin-left:4px; width: 700px;" class="BasicFormHeadBorder" border="0" cellspacing="0" cellpadding="1">
            ...
            <tr>
                ...
                <td rowspan="3" class="BasicFormHeadHead" style="width: 13px;text-align: center;">
                主要工作
                </td>
                <td rowspan="3" class="style17">
                    <cc1:SingleField ID="Owork" runat="server" Height="82px" 
                ...
                <td rowspan="3" class="style17">
                    <cc1:SingleField ID="Nwork" runat="server" Height="82px" 
                        MultiLine="True" Width="295px" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
             <td  class="BasicFormHeadHead" style="width: 70px;text-align: center;" >
                <cc1:GlassButton ID="GlassButton1" runat="server" Text="忘記密碼?" Height="16px" Width="69px" 
                        onclick="wjmm_Click" />
                </td>   
            </tr>
            </table>
         ...
         <table style="margin-left:4px; width: 700px;" class="BasicFormHeadBorder" border="0" cellspacing="0" cellpadding="1">
            <tr>
                ...
                <td class="BasicFormHeadHead">
                    公開課晉升培訓</td>
                <td class="BasicFormHeadDetail"><cc1:SingleField ID="gkk" runat="server" 
                        Width="61px" /></td>
                <td class="BasicFormHeadHead">
                    部門晉升培訓</td>
                <td class="BasicFormHeadDetail"><cc1:SingleField ID="bmj" runat="server" 
                        Width="61px" /></td>
            </tr>
         </table>
         <table style="margin-left:4px; width: 700px;" class="BasicFormHeadBorder" border="0" cellspacing="0" cellpadding="1">
