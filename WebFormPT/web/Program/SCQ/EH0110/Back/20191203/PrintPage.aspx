...
<br />
     ...
     <tr><td align="center" height="30" style="width: 670px">
            <font style="font-family: 標楷體; font-weight: 700;" class="style1">人員異動單</font></td></tr>
     </table>
            ...
            <td class="BasicFormHeadHead" style="width: 37px; height: 26px">
             ...
             <td class="BasicFormHeadDetail">
                    <cc1:SingleOpenWindowField ID="EmpNo" runat="server" Width="198px" showReadOnlyField="True"
                        ...
                        idIndex="0" ReadOnly="True" />
                </td>
                <td class="BasicFormHeadHead" style="width: 37px; height: 26px">
                    <cc1:DSCLabel ID="DSCLabel12" runat="server" Text="到職日期" Width="72px" />
                </td>
                <td class="BasicFormHeadDetail">
                    <cc1:SingleDateTimeField ID="ComeDate" runat="server" Width="124px" 
                        Height="16px" />
                </td>
                <td class="BasicFormHeadHead" style="width: 37px; height: 26px">
                ...
                <td class="BasicFormHeadDetail">
                    <cc1:SingleField ID="NZ" runat="server" Width="114px" Height="16px" 
                        ReadOnly="True" />
                </td>
        </tr>
     </table>
