...
public partial class Program_System_Form_STAD003_Form : SmpBasicFormPage
{
    ...
    protected override void initUI(com.dsc.kernal.factory.AbstractEngine engine, com.dsc.kernal.databean.DataObject objects)
    {
        try
        {
            ...
            if (SingleDropDownListGS.ValueText.Equals(""))
            {
                ...
                SingleDropDownListGS.ValueText = orgId;
            }
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        try
        {
            ...
            string managerId = values[0];  //申請人的主管 工號

            //string[] strgr = FH_GRXX(originatorId);//獲取個人信息
            //string[] zc ={ "副理", "專案經理", "經理", "資深經理", "處長", "特助", "副總經理", "總經理" };

            //bool isb= fh_sziscz(zc, strgr[2]);
             int isqh=4;//是否簽核  1=部級；2=處級;3=總經理；4=董事長   
            /*新增直接員工 逅補直接員工 簽到總經理  其他的簽到董事長 */

            if (SingleDropDownListLb.ValueText == "新增直接員工"
                || SingleDropDownListLb.ValueText == "逅補直接員工")
            {
                isqh = 3;
            }            
            ...
            xml += "<txtShr DataType=\"java.lang.String\">" + "" + "</txtShr>";//審核人
            xml += "<txtZszg DataType=\"java.lang.String\">" + managerId + "</txtZszg>";//申请人主管
            xml += "<txtCbr DataType=\"java.lang.String\">C145145</txtCbr>";//承办人
            xml += "<txtCbrzg DataType=\"java.lang.String\">C090297</txtCbrzg>"; //承办人主管      
    ...
    protected override void showData(AbstractEngine engine, DataObject objects)
    {
        ...
        SingleFieldRs.ValueText = objects.getData("PersonnelCount");//人員類型
        ...
        SingleFieldXqyy.ValueText = objects.getData("PersonnelCount");//需求原因
       ...
       string by=objects.getData("IsMilitaryservice");//是否兵役
        ...
        SingleFieldGzzwsm.ValueText = objects.getData("DemandPosition");//技能
    ...
    protected void APMONEY00SQR_SingleOpenWindowButtonClick(string[,] values)
    {
        ...
        {
            //申請人Email,英文名           
            string[] userValues = base.getUserInfoById(engine, APMONEY00SQR.ValueText);
            if (userValues[0] != "")
            {
