<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form.aspx.cs" Inherits="Program_SCQ_Form_STHR001_Form" %>
     ...
     <cc1:SingleField id="Subject" runat="server" Display="False"></cc1:SingleField><br />
       <cc1:DSCGroupBox ID="DSCGroupBox2" runat="server" Text="申請信息" Width="720px">
        ...
        <tr>
            ...
            <font style="font-family: 標楷體; font-size: large;"><b>SMP&nbsp;人&nbsp;員&nbsp;需&nbsp;求&nbsp;申&nbsp;請&nbsp;單</b></font></td>
        </tr>
