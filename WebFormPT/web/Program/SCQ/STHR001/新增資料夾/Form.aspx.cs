...
public partial class Program_SCQ_Form_STHR001_Form : SmpBasicFormPage
{
    ...
    protected override void initUI(com.dsc.kernal.factory.AbstractEngine engine, com.dsc.kernal.databean.DataObject objects)
    {
        try
        {
           ...
           // string[,] strgs = base.getgsb(engine);
            ...
            //申請人Email,英文名           
            //string[] userValues = mail[0] + "_" + mail[1]; //base.getUserInfoById2(engine, si.fillerID);
           // Hashtable Euser = (Hashtable)base.getHRUsers(engine, userId);
           // if (userValues[0] != "")
           // {
                SingleFieldBMMC.ValueText = si.fillerOrgID;//部門
           // }
        ...
        if (actName.Equals(""))
        {
            ...
            if (Subject.ValueText.Equals(""))
            {
              ...
              //  string subject = values[1];
                if (Subject.ValueText.Equals(""))
                {
                      Subject.ValueText = (string)Session["UserId"]; //subject;
                }
            }
        }
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        try
        {
            ...
            xml += "<txtZszg DataType=\"java.lang.String\">" + "" + "</txtZszg>";//申请人主管
    ...
    protected void APMONEY00SQR_SingleOpenWindowButtonClick(string[,] values)
    {
        ...
        try
        {
           ...
           // string[] userValues = base.getUserInfoById2(engine, APMONEY00SQR.ValueText);
             ...
             // if (userValues[0] != "")
           //{
               // SingleDropDownListGS.ValueText = ""; //公司別
              SingleFieldBMMC.ValueText = si.fillerOrgID;//userValues[6];//部門
