    ...
    <div>
     ...
     <tr>
      <td align="center" height="30" style="width: 670px">
        ...
        <table style="margin-left:4px; width:670px; " class="BasicFormHeadBorder" border="0" cellpadding="1">
   <%--     <tr>
        ...
        <td class="BasicFormHeadDetail" style="width: 331px; height: 26px;">
        ...
        <td class="BasicFormHeadDetail" style="width: 330px; height: 26px">
        ...
        <td class="BasicFormHeadDetail" style="height: 29px; width: 331px;">          
        ...
        <td class="BasicFormHeadDetail" style="height: 29px; width: 330px;">
        ...
        <td class="BasicFormHeadDetail" style="height: 29px; width: 124px;">
         ...
         <td class="BasicFormHeadDetail" style="width: 331px; height: 27px">
         ...
         <td class="BasicFormHeadDetail" style="height: 27px; width: 330px;">
       ...
       >  </cc1:DSCLabel>
         ...
         <td class="BasicFormHeadDetail" style="height: 37px; width: 331px;">
         ...
         <td class="BasicFormHeadDetail" style="height: 37px; width: 330px;">
