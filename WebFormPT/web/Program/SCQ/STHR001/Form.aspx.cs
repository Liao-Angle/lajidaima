    ...
    protected override void initUI(com.dsc.kernal.factory.AbstractEngine engine, com.dsc.kernal.databean.DataObject objects)
    {
        try
        {
           ...
           // string[,] strgs = base.getgsb(engine);
            ...
            SingleDropDownListGS.ReadOnly = false;//不能選擇
            #endregion
...
*/
    ...
    protected override bool checkFieldData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (SingleDropDownListLb.ValueText.Contains("間接")&&base.attachFile.dataSource.getAvailableDataObjectCount() < 1)
        {
            MessageBox("附件需上傳：部門組織架構");
        }
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        try
        {
            ...
            /*新增直接員工 逅補直接員工 簽到總經理  其他的簽到董事長 */
		     ...
		     int isqh=3;
             if (SingleDropDownListLb.ValueText == "逅補間接員工" || SingleDropDownListLb.ValueText == "新增間接員工")
             {
                 isqh = 4;
             }         
