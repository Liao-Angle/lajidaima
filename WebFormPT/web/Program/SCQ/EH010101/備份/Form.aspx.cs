...
public partial class Program_SCQ_Form_EH010101_Form : SmpBasicFormPage
{
   ...
   try
    ...
    private bool checkServerData(AbstractEngine engine)
    {
        string SSql = @"select * from dbo.EH010101A where EmpNo='" + EmpNo.ValueText + "' and WorkDate='" + WorkDate.ValueText + "'  and IS_LOCK<>'Y'";// @"and ETime=''
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        xml += "<CheckED DataType=\"java.lang.String\">" + si.fillerID  + "</CheckED>";
