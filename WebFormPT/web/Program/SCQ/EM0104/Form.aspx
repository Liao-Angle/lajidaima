<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form.aspx.cs" Inherits="Program_SCQ_Form_EM0104_Form" %>
                 ...
                 <Panel ID="EditPanel" width="100%" runat="server">
                    <table width="100%">
                        <tr>
                            ...
                            <td class=BasicFormHeadHead>
                                <cc1:DSCLabel ID="LBHead2" runat="server" Text="英文名字"></cc1:DSCLabel>
                            </td>
                            <td class=BasicFormHeadHead>
                        ...
                        <tr>
                            ...
                            <td class=BasicFormHeadDetail>
                                <cc1:SingleField ID="EnglishName" runat="server" Width="80px" />
                            </td>
                            <td class=BasicFormHeadDetail>
                            ...
                            <td class=BasicFormHeadDetail>
                                <cc1:SingleDropDownList ID="PrivilegeID" 
