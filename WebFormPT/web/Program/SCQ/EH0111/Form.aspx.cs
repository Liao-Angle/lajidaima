...
public partial class Program_SCQ_Form_EH0111_Form : SmpBasicFormPage
{
    ...
    private void OldInfo(AbstractEngine engine)
    {
        try
        {
            ...
            if (h1["DtName"].ToString() == "工程師" || h1["DtName"].ToString() == "副工程師" || h1["DtName"].ToString() == "副管理師" || h1["DtName"].ToString() == "管理師" || h1["DtName"].ToString() == "副主任" || h1["DtName"].ToString() == "組長")
            {
                ODt.ValueText = "三職等";
            }
    ...
    protected void JEmpNo_SingleOpenWindowButtonClick(string[,] values)
    {
        ...
        try
        {
            ...
            if (bm.Contains(si.fillerOrgID.ToString().Substring(0, 7)) || (si.fillerOrgID.ToString().Substring(0, 7) == "PIM0108" && bm == "PQM0107-模切") || (si.fillerOrgID.ToString().Substring(0, 7) == "GQM0110" && bm == "GIM0110-廠務")|| (si.fillerOrgID.ToString().Substring(0, 7) == "GQC2200" && bm == "GIC2200-GA"))
            {
