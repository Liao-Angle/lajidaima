...
public partial class Program_SCQ_Form_EM0103_Form : SmpBasicFormPage
{
    protected override void init()
    {
        ProcessPageID = "EM0103";
        AgentSchema = "WebServerProject.form.EM0103.EM0103Agent";
    ...
    protected override void initUI(AbstractEngine engine, DataObject objects)
    {
        ...
        string role = sp.getParam("FlowRoleType");
        if (!role.Equals(""))
        {
            string[] strs = role.Split(new char[] { ';' });
            ...
            RoleID.setListItem(ids);
        }
        string[,] aids = new string[2, 2] { { "ADD", "新增" }, { "DEL", "刪除" } };
        ActionID.setListItem(aids);
        ...
        if (base.isNew())
        {
            ...
            dos.setChildClassString("WebServerProject.form.EM0103.EM0103B");
            dos.setTableName("EM0103B");
            dos.loadFileSchema();
            objects.setChild("EM0103B", dos);
        ...
        ApplicationList.HiddenField = new string[] { "GUID", "SheetNo", "RoleID" };
    ...
    protected override void showData(AbstractEngine engine, DataObject objects)
    {
        ...
        ApplicationList.dataSource = objects.getChild("EM0103B");
        ApplicationList.updateTable();
    ...
    protected override void saveData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (isAddNew)
        {
            ...
            objects.setChild("EM0103B", ApplicationList.dataSource);
        }
    }
    ...
    protected void AddData_Click(object sender, EventArgs e)
    {
        ...
        obj.setData("ActionID", ActionID.ValueText);
        obj.setData("RoleID", RoleID.ValueText);
        obj.setData("RoleName", RoleID.ReadOnlyText);
