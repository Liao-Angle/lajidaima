...
public partial class SmpProgram_System_Form_SPIT001_Form : SmpBasicFormPage
{
    ...
    {
          ProcessPageID = "EM01011"; //=作業畫面代碼
          AgentSchema = "WebServerProject.form.EM01011.EM01011Agent";
    ...
    protected override void initUI(AbstractEngine engine, DataObject objects)
    {
        ...
        try
        {
            //公司別
            //ids = new string[,]{
            //    {"SCQ",com.dsc.locale.LocaleString.getSystemMessageString("smpprogram_system_form_spit001_form_aspx.language.ini", "message", "SCQ", "重慶新普")}
            //};
            //Company.setListItem(ids);
            //if (Company.ValueText.Equals(""))
            //{
            //    Company.ValueText = "SCQ";
            //}
              Company.ValueText = "SCQ重慶新普";
            //申請部門
            ...
            ////申請人工號. 中文名. 英文名. 職稱
            //Hashtable usertable = base.getHRUsers(engine, si.fillerID);
            //if (usertable != null)     
            //{/*
