...
public partial class Program_SCQ_Form_EH0114_Form : SmpBasicFormPage
{
    protected override void init()
    {
        ProcessPageID = "EH0114";
        AgentSchema = "WebServerProject.form.EH0114.EH0114Agent";
    ...
    protected override void initUI(AbstractEngine engine, DataObject objects)
    {
        ...
        string[,] PT = new string[3, 2] { { "請選擇", "請選擇" }, { "社招", "社招" }, { "學生", "學生" } };
        PerType.setListItem(PT);
    ...
    protected override void showData(AbstractEngine engine, DataObject objects)
    {
        ...
        LZReason.ValueText = objects.getData("LZReason");
        bz.ValueText = objects.getData("bz");
        PerType.ValueText = objects.getData("PerType");
        first.ValueText = objects.getData("first");
        second.ValueText = objects.getData("second");
        third.ValueText = objects.getData("third");
        //顯示發起資料
    ...
    protected override void saveData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (isAddNew)
        {
            ...
            objects.setData("LZReason", LZReason.ValueText);
            objects.setData("bz", bz.ValueText);
            objects.setData("PerType", PerType.ValueText);
            objects.setData("first", first.ValueText);
            objects.setData("second", second.ValueText);
            objects.setData("third", third.ValueText);
    ...
    protected override bool checkFieldData(AbstractEngine engine, DataObject objects)
    {
        ...
        //if (isNecessary(RequestID))
        //{
        //    if (RequestID.GuidValueText.Equals(""))
        //    {
