<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form1.aspx.cs" Inherits="Program_SCQ_Form_EH010201_Form" %>
            ...
            <table style="margin-left: 4px" border="0" width="666px" cellspacing="0" cellpadding="1" class="BasicFormHeadBorder">
                <tr id="Rows" runat="server">
                    <td colspan="4" style="width: 669px; height: 70px; margin-left: 40px;">
                        <cc1:DSCTabControl ID="DSCTabControl1" runat="server" Height="70px" Width="667px">
                            <TabPages>
                                <cc1:DSCTabPage runat="server" Title="个人" Enabled="True" ImageURL="" Hidden="False" ID="DSCTabPage1">
                                    <TabBody>
                                        <table style="margin-left: 0px" class="BasicFormHeadBorder" cellspacing="0" cellpadding="1" width="663" border="0">
                                            <tbody>
                                                <tr>
                                                    <td style="width: 100px" class="BasicFormHeadHead" align="right">
                                                        <cc1:DSCLabel ID="LBEmpNo" runat="server" Width="100%" Text="員工"></cc1:DSCLabel>
                                                    </td>
                                                    <td class="BasicFormHeadDetail" width="220">&nbsp;<cc1:SingleOpenWindowField ID="EmpNo" runat="server" Width="200px" idIndex="0" valueIndex="1" tableName="hrusers" serialNum="001" keyField="EmpNo" guidField="EmpNo" showReadOnlyField="True" __designer:wfdid="w1"></cc1:SingleOpenWindowField>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <cc1:DSCTabPage runat="server" Title="部门" Enabled="True" ImageURL="" Hidden="False" ID="DSCTabPage2">
                                    <TabBody>
                                ...
                                <cc1:DSCTabPage runat="server" Title="线别" Enabled="True" ImageURL="" Hidden="False" ID="DSCTabPage3">
                                    <TabBody>
                                        <div style="text-align: center">
                ...
                <tr id="Rows1" runat="server">
                    <td width="80" align="right" class="BasicFormHeadHead">
                        <cc1:DSCLabel ID="LBWorkDate" runat="server" Text="加班日期" Width="100%"></cc1:DSCLabel>
                    </td>
                ...
                <tr id="Rows2" runat="server">
                    ...
                    <td class="BasicFormHeadDetail">
                        <cc1:SingleDropDownList ID="STime1" runat="server" Width="60px" OnSelectChanged="STime1_SelectChanged" />
                        <cc1:SingleDropDownList ID="STime3" runat="server" Width="60px" OnSelectChanged="STime1_SelectChanged" />
                    </td>
                    <td align="right" class="BasicFormHeadHead" style="height: 24px">
                ...
                <tr id="Rows6" runat="server">
                    <td colspan="4" class="BasicFormHeadDetail">&nbsp;</td>
                </tr>


                <tr>
                    <td class="BasicFormHeadDetail" colspan="4" valign="top">&nbsp;<cc1:OutDataList
                        ID="OverTimeList" runat="server" Height="250px"
                        OnSaveRowData="RequestList_SaveRowData" ViewStateMode="Disabled" Width="631px"
                        showExcel="True" NoModify="True"></cc1:OutDataList>
                        ...
                        <span style="margin-top: 0px; padding-top: 0px">
                            <cc1:FileUpload ID="FileUpload1" runat="server" NoDelete="True"
                                ...
                                BorderStyle="None" ViewStateMode="Disabled" Height="250px" />
