            ...
            <table style="margin-left:4px; width: 660px;" border="0" cellspacing="0" cellpadding="1">
                <tr>
                    ...
                    <td class="BasicFormHeadDetail">
                        ...
                        <cc1:SingleField id="bx0" runat="server" Display="False" Width="122px" ></cc1:SingleField>
                    </td>
                    <td class="BasicFormHeadHead" style="width: 37px; height: 26px">
                    ...
                    <td class="BasicFormHeadDetail">
                        <cc1:SingleDropDownList ID="zgjg" runat="server" Width="122px" 
                            onselectchanged="total_SelectChanged" />
                            <cc1:SingleField id="zg0" runat="server" Display="False" Width="122px"></cc1:SingleField>
                    </td>
                </tr>
                <tr>
                    <td class="BasicFormHeadHead" style="width: 37px; height: 26px">
                    ...
                    <td class="BasicFormHeadDetail">
                        <cc1:SingleDropDownList ID="zwjg" runat="server" Width="122px" 
                            onselectchanged="total_SelectChanged" />
                            <cc1:SingleField id="zw0" runat="server" Display="False" Width="122px"></cc1:SingleField>
                    </td>
                    <td class="BasicFormHeadHead" style="width: 37px; height: 26px">
                    ...
                    <td class="BasicFormHeadDetail">
                        <cc1:SingleField ID="zyjg" runat="server" Width="122px" 
                            ontextchanged="total_SelectChanged"/>
                            <cc1:SingleField id="zy0" runat="server" Display="False" Width="122px" 
                ...
                <tr>
                    ...
                    <td class="BasicFormHeadDetail">
                        ...
                        <cc1:SingleField id="qx0" runat="server" Display="False" Width="122px"></cc1:SingleField>
                    </td>
                </tr>
                <tr>
                    <td class="BasicFormHeadHead" style="width: 37px; height: 26px">
                    ...
                    <td class="BasicFormHeadDetail">
                        <cc1:SingleField ID="jbfjs" runat="server" Width="122px" 
                         ...
                         <cc1:SingleField id="jbfjs0" runat="server" Display="False" Width="122px"></cc1:SingleField>
                    </td>
                    <td class="BasicFormHeadHead" style="width: 37px; height: 26px">
                    ...
                    <td class="BasicFormHeadDetail">
                        <cc1:SingleField ID="password" runat="server" Width="101px" isPassword="True" />
