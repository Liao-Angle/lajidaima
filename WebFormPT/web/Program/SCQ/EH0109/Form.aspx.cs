...
public partial class Program_SCQ_Form_EH0109_Form : SmpBasicFormPage
{
    ...
    {
        ProcessPageID = "EH0109";
        AgentSchema = "WebServerProject.form.EH0109.EH0109Agent";
    ...
    protected override void saveData(AbstractEngine engine, DataObject objects)
    {
        ...
        {
            objects.setData("zyjg", zyjg.ValueText);
            objects.setData("qx", qx0.ValueText);
            base.saveData(engine, objects);
        }
    }
    ...
    protected override bool checkFieldData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (Dt.ValueText == "一職等" && Convert.ToDouble(zyjg.ValueText) > 290)
        {
            MessageBox("二職等專業加給不得大於290");
            result = false;
        }
        ...
        if (bx0.ValueText =="0"&& bx.ValueText=="0")
        {
            MessageBox("請驗證薪資");
            result = false;
        }
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        //if (creatorId != BmInfo[3]&& base.getUserManagerInfoID(engine, creatorId)[1]!=zjl)
        //{
        //    bmzg = values[1];
        //    isqh = "1";
    ...
    {
        qx0.ValueText = Convert.ToDouble(bx0.ValueText) + Convert.ToDouble(zg0.ValueText) + Convert.ToDouble(zw0.ValueText) + Convert.ToDouble(zyjg.ValueText) + "";
    }
    ...
    protected void PrintButton_OnClick(object sender, EventArgs e)
    {
        ...
        Session["EH0109_SheetNo"] = SheetNo.ValueText;
        string url = "PrintPage.aspx";
        base.showOpenWindow(url, "列印任用單", "", "600", "", "", "", "1", "1", "", "", "", "", "750", "", true);
    }
    protected void total_SelectChanged(object sender, EventArgs e)
    {
        getQX();
    }
