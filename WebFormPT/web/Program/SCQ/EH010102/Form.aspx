...
<body leftmargin=0 topmargin=0>
    ...
    <div>
     ...
     <table style="margin-left:4px; width: 660px;" border=0 cellspacing=0 cellpadding=1>  
        ...
        <tr valign=middle > 
		    <td align=center height="40"><font style="font-family: 標楷體; font-size: large;"><b>異常出勤修正單</b></font></td>
	    </tr>
	</table>
        ...
        <tr>
            ...
            <td class=BasicFormHeadDetail>
                                <cc1:SingleDateTimeField ID="WorkDate" runat="server" 
                                    Width="120px" ondatetimeclick="WorkDate_DateTimeClick" />  
            </td>
            <td align=right class=BasicFormHeadHead style="height: 24px">
...
<tr runat="server" id="showzg" visible="false">
          ...
          <cc1:DSCLabel ID="DSCLabel1" runat="server" Text="請選擇簽核主管" Width="150px" Height="20px"></cc1:DSCLabel>
             </td>
              <td class="BasicFormHeadHead" colspan="3" style="height: 17px">
        ...
        <cc1:DSCLabel ID="DSCLabel2" runat="server" Text="超過三天請用異常出勤修正單。" 
                    Width="100%" Font-Size="X-Large" ForeColor="Red"></cc1:DSCLabel>
    </div>
    </form>
</body>
</html>
