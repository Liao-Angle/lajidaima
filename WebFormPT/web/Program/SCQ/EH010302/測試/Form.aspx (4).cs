...
public partial class Program_SCQ_Form_EH010302_Form : SmpBasicFormPage
{
    ...
    protected override void initUI(AbstractEngine engine, DataObject objects)
    {
        ...
        if (!leave.Equals(""))
        {
            ...
            string[,] ids = new string[strs.Length+1, 2];
            ...
            for (int i = 0; i < strs.Length; i++)
            {
                ...
                {
                    ids[i+1, 0] = strs[i].Split(new char[] { '/' })[0];
                    ids[i+1, 1] = strs[i].Split(new char[] { '/' })[1];
                }
            }
    ...
    protected override bool checkFieldData(AbstractEngine engine, DataObject objects)
    {
        ...
        string actName = (string)getSession("ACTName");
        if (actName == "直屬主管" && LeaveTypeID.ValueText=="-1")
        {
            pushErrorMessage("請您選擇假別");
            result = false;
        }
        return result;
    }
