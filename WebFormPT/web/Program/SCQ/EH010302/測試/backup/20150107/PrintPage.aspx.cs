...
public partial class Program_SCQ_Form_EH010302_PrintPage : BaseWebUI.GeneralWebPage  //System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
			...
			string strSheetNo = (string)Session["EH010302_SheetNo"] ;
            if(Session["EH010302_SheetNo"] != null) 
            {
                strSheetNo = (string)Session["EH010302_SheetNo"];				
            }
            ...
            //顯示使用者資訊
			sql = "select aa.EmpNo+'-'+aa.EmpName as EmpInfo, LeaveTypeName, Reason, SheetNo, Hours  ";
			...
			sql = sql + " FROM EH010301A a,  EH010301B b, SMWYAAA s  ";
			...
			sql = sql + " ) aa left join HRUSERS hr on hr.EmpNo=aa.EmpNo ";
            ...
            {                
				...
				lblLeaveHours.Text = ds.Tables[0].Rows[0]["Hours"].ToString();
