  ...
  string[,] BB = new string[3, 2]{{"0","白班"},{"1","夜班"},{"2","中班"}};
    ...
    protected override bool checkFieldData(AbstractEngine engine, DataObject objects)
    {
        ...
        if (isNecessary(Reason))
        {
            ...
            if (actName == "直屬主管")
            {
                ...
                if (LeaveTypeID.ValueText.Equals("請選擇假別")||LeaveTypeID.ValueText.Equals("-1"))
                {
    ...
    protected override string setFlowVariables(AbstractEngine engine, Hashtable param, DataObject currentObject)
    {
        ...
        try
        {
            ...
            mrgmrgID = base.getUserManagerInfoID(engine, managerId)[1];//上一級主管
            ...
            xml += "<mrgmrg DataType=\"java.lang.String\">" + mrgmrgID + "</mrgmrg>";//上級主管
