<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Form.aspx.cs" Inherits="Program_SCQ_Form_EH010301_Form" %>
    ...
    <table style="margin-left:4px; width: 660px;" border=0 cellspacing=0 cellpadding=1>  
        ...
        <tr>
            <td align="right" class=BasicFormHeadHead>
                <cc1:DSCLabel ID="DSCLabel1" runat="server" Text="主旨" Width="100%"></cc1:DSCLabel>
            </td>
            <td class=BasicFormHeadDetail colspan=3><cc1:DSCLabel ID="zz" runat="server" Text="" />
            </td>
        </tr>
        <tr>
            <td align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="DSCLabel4" runat="server" Text="公司別" Width="146%"></cc1:DSCLabel>
            </td>
            <td class=BasicFormHeadDetail><cc1:DSCLabel ID="DSCLabel5" runat="server" Text="重慶新普" />
            </td>
            <td width="500px" align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="DSCLabel6" runat="server" Text="請假人員部門" Width="200%" />
                </td>
            <td class=BasicFormHeadDetail colspan=3><cc1:DSCLabel ID="PT" runat="server" Text="" />
            </td>
        </tr>
        <tr>
            <td width="380px" align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="LBEmpNo" runat="server" Text="請假人" Width="154%"></cc1:DSCLabel></td>
            ...
            <td width="100px" align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="dlry" runat="server" Text="代理人員" Width="100%"></cc1:DSCLabel></td>
            <td width="220px" class=BasicFormHeadDetail>
                <cc1:SingleOpenWindowField ID="EmpNo1" runat="server" Width="254px" showReadOnlyField="True" guidField="EmpNo" keyField="EmpNo" serialNum="001" tableName="hrusers" OnSingleOpenWindowButtonClick="EmpNo_SingleOpenWindowButtonClick" valueIndex="1" idIndex="0" />
            </td>
        </tr>
        <tr>
            <td width="800px" align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="DSCLabel8" runat="server" Text="流程類型" Width="234%" />
            </td>
            <td class=BasicFormHeadDetail><cc1:DSCLabel ID="DSCLabel7" runat="server" Text="自定" />
            </td>
            <td align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="DSCLabel10" runat="server" Text="班別" Width="100%" />
                </td>
            <td class=BasicFormHeadDetail><cc1:DSCLabel ID="DSCLabel11" runat="server" Text="" />
            </td>
        </tr>
        <tr>
            <td align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="DSCLabel12" runat="server" Text="假別" Width="200%"></cc1:DSCLabel>
            <td width="380px" class=BasicFormHeadDetail>
                <cc1:SingleDropDownList ID="LeaveTypeID" 
                    runat="server" Width="110px" /> 
            </td>
            <td align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="DSCLabel14" runat="server" Text="請假含假日" Width="100%" />
                </td>
            <td width="220px" class=BasicFormHeadDetail>
                <cc1:SingleDropDownList ID="SFJR" 
                    runat="server" Width="110px" /> 
            </td>
        </tr>
        <tr>
            <td width="380px" align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="LBDtName" runat="server" Text="職稱" Width="200%"></cc1:DSCLabel>
            </td>
        ...
        <tr>
            <td witdth=380px align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="LBYearStatus" runat="server" Text="年度狀況" Width="200%"></cc1:DSCLabel>
            </td>
            <td class=BasicFormHeadDetail colspan=3><cc1:DSCLabel ID="YearStatus" runat="server" Text="" />
            </td>
        </tr>
        <tr>
            <td width="380px" valign=top align=right class=BasicFormHeadHead>
                <cc1:DSCLabel ID="LBReason" runat="server" Text="說明" Width="200%"></cc1:DSCLabel>
            </td>
        ...
        <tr>
            <td witdth=380px align=right class=BasicFormHeadHead valign="top" rowspan=3>
                <cc1:DSCLabel ID="LBLeaveDate" runat="server" Text="請假時間" Width="226%"></cc1:DSCLabel>
            </td>
